...
//const Char_t* pdf_dir = "pdf_for_1_6q2_kll/";    // 1
//const Char_t* pdf_dir = "pdf_for_1_6q2_kstrll/"; // 2
const Char_t* pdf_dir = "pdf_for_1_6q2_xsll/";   // 3
...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  if( Nbin_afb == 14 ){
    ...
    if( fl_xsid==1 ){ // for K ll
      r_tt[ 0][ 0] = new RooRealVar( "r_tt0",    "r_tt0",   0.0003994);   r_tf[ 0][ 0] = new RooRealVar( "r_tf0",    "r_tf0",           0);   r_f [ 0][ 0] = new RooRealVar( "r_f0",     "r_f0",    7.697e-06); 
      r_tt[ 0][ 1] = new RooRealVar( "r_tt1",    "r_tt1",    0.001224);   r_tf[ 0][ 1] = new RooRealVar( "r_tf1",    "r_tf1",           0);   r_f [ 0][ 1] = new RooRealVar( "r_f1",     "r_f1",    1.668e-05); 
      r_tt[ 0][ 2] = new RooRealVar( "r_tt2",    "r_tt2",   0.0009908);   r_tf[ 0][ 2] = new RooRealVar( "r_tf2",    "r_tf2",   4.655e-05);   r_f [ 0][ 2] = new RooRealVar( "r_f2",     "r_f2",    4.362e-05); 
      r_tt[ 0][ 3] = new RooRealVar( "r_tt3",    "r_tt3",    0.001094);   r_tf[ 0][ 3] = new RooRealVar( "r_tf3",    "r_tf3",           0);   r_f [ 0][ 3] = new RooRealVar( "r_f3",     "r_f3",    6.414e-05); 
      r_tt[ 0][ 4] = new RooRealVar( "r_tt4",    "r_tt4",   0.0004266);   r_tf[ 0][ 4] = new RooRealVar( "r_tf4",    "r_tf4",    0.001607);   r_f [ 0][ 4] = new RooRealVar( "r_f4",     "r_f4",    2.053e-05); 
      r_tt[ 0][ 5] = new RooRealVar( "r_tt5",    "r_tt5",    0.001071);   r_tf[ 0][ 5] = new RooRealVar( "r_tf5",    "r_tf5",    0.003093);   r_f [ 0][ 5] = new RooRealVar( "r_f5",     "r_f5",     8.98e-06); 
      r_tt[ 0][ 6] = new RooRealVar( "r_tt6",    "r_tt6",     0.01321);   r_tf[ 0][ 6] = new RooRealVar( "r_tf6",    "r_tf6",     0.02696);   r_f [ 0][ 6] = new RooRealVar( "r_f6",     "r_f6",    0.0006812); 
      r_tt[ 0][ 7] = new RooRealVar( "r_tt7",    "r_tt7",    0.009758);   r_tf[ 0][ 7] = new RooRealVar( "r_tf7",    "r_tf7",     0.03476);   r_f [ 0][ 7] = new RooRealVar( "r_f7",     "r_f7",    0.0008018); 
      r_tt[ 1][ 0] = new RooRealVar( "r_tt8",    "r_tt0",   0.0002054);   r_tf[ 1][ 0] = new RooRealVar( "r_tf8",    "r_tf0",           0);   r_f [ 1][ 0] = new RooRealVar( "r_f8",     "r_f0",            0); 
      r_tt[ 1][ 1] = new RooRealVar( "r_tt9",    "r_tt1",           0);   r_tf[ 1][ 1] = new RooRealVar( "r_tf9",    "r_tf1",           0);   r_f [ 1][ 1] = new RooRealVar( "r_f9",     "r_f1",    2.566e-06); 
      r_tt[ 1][ 2] = new RooRealVar( "r_tt10",   "r_tt2",   0.0003122);   r_tf[ 1][ 2] = new RooRealVar( "r_tf10",   "r_tf2",           0);   r_f [ 1][ 2] = new RooRealVar( "r_f10",    "r_f2",    1.796e-05); 
      r_tt[ 1][ 3] = new RooRealVar( "r_tt11",   "r_tt3",   0.0004041);   r_tf[ 1][ 3] = new RooRealVar( "r_tf11",   "r_tf3",           0);   r_f [ 1][ 3] = new RooRealVar( "r_f11",    "r_f3",    1.283e-05); 
      r_tt[ 1][ 4] = new RooRealVar( "r_tt12",   "r_tt4",   0.0008794);   r_tf[ 1][ 4] = new RooRealVar( "r_tf12",   "r_tf4",   0.0009256);   r_f [ 1][ 4] = new RooRealVar( "r_f12",    "r_f4",    2.181e-05); 
      r_tt[ 1][ 5] = new RooRealVar( "r_tt13",   "r_tt5",   0.0005846);   r_tf[ 1][ 5] = new RooRealVar( "r_tf13",   "r_tf5",    0.001759);   r_f [ 1][ 5] = new RooRealVar( "r_f13",    "r_f5",    2.566e-05); 
      r_tt[ 1][ 6] = new RooRealVar( "r_tt14",   "r_tt6",    0.006509);   r_tf[ 1][ 6] = new RooRealVar( "r_tf14",   "r_tf6",     0.01651);   r_f [ 1][ 6] = new RooRealVar( "r_f14",    "r_f6",    0.0005465); 
      r_tt[ 1][ 7] = new RooRealVar( "r_tt15",   "r_tt7",    0.005618);   r_tf[ 1][ 7] = new RooRealVar( "r_tf15",   "r_tf7",     0.02015);   r_f [ 1][ 7] = new RooRealVar( "r_f15",    "r_f7",     0.000594); 
      r_tt[ 2][ 0] = new RooRealVar( "r_tt16",   "r_tt0",   0.0003231);   r_tf[ 2][ 0] = new RooRealVar( "r_tf16",   "r_tf0",           0);   r_f [ 2][ 0] = new RooRealVar( "r_f16",    "r_f0",    7.697e-06); 
      r_tt[ 2][ 1] = new RooRealVar( "r_tt17",   "r_tt1",   0.0007402);   r_tf[ 2][ 1] = new RooRealVar( "r_tf17",   "r_tf1",           0);   r_f [ 2][ 1] = new RooRealVar( "r_f17",    "r_f1",    1.924e-05); 
      r_tt[ 2][ 2] = new RooRealVar( "r_tt18",   "r_tt2",   0.0006987);   r_tf[ 2][ 2] = new RooRealVar( "r_tf18",   "r_tf2",   2.662e-05);   r_f [ 2][ 2] = new RooRealVar( "r_f18",    "r_f2",    6.158e-05); 
      r_tt[ 2][ 3] = new RooRealVar( "r_tt19",   "r_tt3",   0.0007985);   r_tf[ 2][ 3] = new RooRealVar( "r_tf19",   "r_tf3",           0);   r_f [ 2][ 3] = new RooRealVar( "r_f19",    "r_f3",    7.697e-05); 
      r_tt[ 2][ 4] = new RooRealVar( "r_tt20",   "r_tt4",   0.0007371);   r_tf[ 2][ 4] = new RooRealVar( "r_tf20",   "r_tf4",    0.001139);   r_f [ 2][ 4] = new RooRealVar( "r_f20",    "r_f4",    4.233e-05); 
      r_tt[ 2][ 5] = new RooRealVar( "r_tt21",   "r_tt5",   0.0007367);   r_tf[ 2][ 5] = new RooRealVar( "r_tf21",   "r_tf5",    0.002178);   r_f [ 2][ 5] = new RooRealVar( "r_f21",    "r_f5",    3.464e-05); 
      r_tt[ 2][ 6] = new RooRealVar( "r_tt22",   "r_tt6",     0.00948);   r_tf[ 2][ 6] = new RooRealVar( "r_tf22",   "r_tf6",     0.02116);   r_f [ 2][ 6] = new RooRealVar( "r_f22",    "r_f6",     0.001228); 
      r_tt[ 2][ 7] = new RooRealVar( "r_tt23",   "r_tt7",    0.007459);   r_tf[ 2][ 7] = new RooRealVar( "r_tf23",   "r_tf7",     0.02662);   r_f [ 2][ 7] = new RooRealVar( "r_f23",    "r_f7",     0.001396); 
    }else if( fl_xsid==2 ){// for K* ll
      r_tt[ 0][ 0] = new RooRealVar( "r_tt0",    "r_tt0",     0.04032);   r_tf[ 0][ 0] = new RooRealVar( "r_tf0",    "r_tf0",    0.009953);   r_f [ 0][ 0] = new RooRealVar( "r_f0",     "r_f0",     7.16e-05); 
      r_tt[ 0][ 1] = new RooRealVar( "r_tt1",    "r_tt1",      0.0378);   r_tf[ 0][ 1] = new RooRealVar( "r_tf1",    "r_tf1",    0.008224);   r_f [ 0][ 1] = new RooRealVar( "r_f1",     "r_f1",    9.391e-05); 
      r_tt[ 0][ 2] = new RooRealVar( "r_tt2",    "r_tt2",     0.07532);   r_tf[ 0][ 2] = new RooRealVar( "r_tf2",    "r_tf2",     0.01614);   r_f [ 0][ 2] = new RooRealVar( "r_f2",     "r_f2",     0.000318); 
      r_tt[ 0][ 3] = new RooRealVar( "r_tt3",    "r_tt3",     0.07528);   r_tf[ 0][ 3] = new RooRealVar( "r_tf3",    "r_tf3",      0.0178);   r_f [ 0][ 3] = new RooRealVar( "r_f3",     "r_f3",     0.000358); 
      r_tt[ 0][ 4] = new RooRealVar( "r_tt4",    "r_tt4",      0.1163);   r_tf[ 0][ 4] = new RooRealVar( "r_tf4",    "r_tf4",     0.04879);   r_f [ 0][ 4] = new RooRealVar( "r_f4",     "r_f4",     0.000225); 
      r_tt[ 0][ 5] = new RooRealVar( "r_tt5",    "r_tt5",      0.1614);   r_tf[ 0][ 5] = new RooRealVar( "r_tf5",    "r_tf5",     0.03248);   r_f [ 0][ 5] = new RooRealVar( "r_f5",     "r_f5",     0.000186); 
      r_tt[ 0][ 6] = new RooRealVar( "r_tt6",    "r_tt6",      0.2723);   r_tf[ 0][ 6] = new RooRealVar( "r_tf6",    "r_tf6",      0.2203);   r_f [ 0][ 6] = new RooRealVar( "r_f6",     "r_f6",     0.002585); 
      r_tt[ 0][ 7] = new RooRealVar( "r_tt7",    "r_tt7",      0.3877);   r_tf[ 0][ 7] = new RooRealVar( "r_tf7",    "r_tf7",      0.1288);   r_f [ 0][ 7] = new RooRealVar( "r_f7",     "r_f7",     0.003007); 
      r_tt[ 1][ 0] = new RooRealVar( "r_tt8",    "r_tt0",     0.02526);   r_tf[ 1][ 0] = new RooRealVar( "r_tf8",    "r_tf0",      0.0056);   r_f [ 1][ 0] = new RooRealVar( "r_f8",     "r_f0",    1.767e-05); 
      r_tt[ 1][ 1] = new RooRealVar( "r_tt9",    "r_tt1",     0.02197);   r_tf[ 1][ 1] = new RooRealVar( "r_tf9",    "r_tf1",    0.006165);   r_f [ 1][ 1] = new RooRealVar( "r_f9",     "r_f1",    1.953e-05); 
      r_tt[ 1][ 2] = new RooRealVar( "r_tt10",   "r_tt2",     0.04794);   r_tf[ 1][ 2] = new RooRealVar( "r_tf10",   "r_tf2",     0.01145);   r_f [ 1][ 2] = new RooRealVar( "r_f10",    "r_f2",    0.0001088); 
      r_tt[ 1][ 3] = new RooRealVar( "r_tt11",   "r_tt3",     0.05012);   r_tf[ 1][ 3] = new RooRealVar( "r_tf11",   "r_tf3",      0.0111);   r_f [ 1][ 3] = new RooRealVar( "r_f11",    "r_f3",    0.0001023); 
      r_tt[ 1][ 4] = new RooRealVar( "r_tt12",   "r_tt4",     0.07487);   r_tf[ 1][ 4] = new RooRealVar( "r_tf12",   "r_tf4",     0.02956);   r_f [ 1][ 4] = new RooRealVar( "r_f12",    "r_f4",    0.0003478); 
      r_tt[ 1][ 5] = new RooRealVar( "r_tt13",   "r_tt5",      0.1036);   r_tf[ 1][ 5] = new RooRealVar( "r_tf13",   "r_tf5",     0.02136);   r_f [ 1][ 5] = new RooRealVar( "r_f13",    "r_f5",    0.0003543); 
      r_tt[ 1][ 6] = new RooRealVar( "r_tt14",   "r_tt6",      0.1689);   r_tf[ 1][ 6] = new RooRealVar( "r_tf14",   "r_tf6",      0.1342);   r_f [ 1][ 6] = new RooRealVar( "r_f14",    "r_f6",     0.002066); 
      r_tt[ 1][ 7] = new RooRealVar( "r_tt15",   "r_tt7",      0.2398);   r_tf[ 1][ 7] = new RooRealVar( "r_tf15",   "r_tf7",     0.07933);   r_f [ 1][ 7] = new RooRealVar( "r_f15",    "r_f7",     0.002263); 
      r_tt[ 2][ 0] = new RooRealVar( "r_tt16",   "r_tt0",     0.03407);   r_tf[ 2][ 0] = new RooRealVar( "r_tf16",   "r_tf0",    0.008203);   r_f [ 2][ 0] = new RooRealVar( "r_f16",    "r_f0",    8.927e-05); 
      r_tt[ 2][ 1] = new RooRealVar( "r_tt17",   "r_tt1",     0.03144);   r_tf[ 2][ 1] = new RooRealVar( "r_tf17",   "r_tf1",     0.00737);   r_f [ 2][ 1] = new RooRealVar( "r_f17",    "r_f1",    0.0001134); 
      r_tt[ 2][ 2] = new RooRealVar( "r_tt18",   "r_tt2",     0.06345);   r_tf[ 2][ 2] = new RooRealVar( "r_tf18",   "r_tf2",     0.01415);   r_f [ 2][ 2] = new RooRealVar( "r_f18",    "r_f2",    0.0004268); 
      r_tt[ 2][ 3] = new RooRealVar( "r_tt19",   "r_tt3",      0.0646);   r_tf[ 2][ 3] = new RooRealVar( "r_tf19",   "r_tf3",     0.01489);   r_f [ 2][ 3] = new RooRealVar( "r_f19",    "r_f3",    0.0004603); 
      r_tt[ 2][ 4] = new RooRealVar( "r_tt20",   "r_tt4",     0.08749);   r_tf[ 2][ 4] = new RooRealVar( "r_tf20",   "r_tf4",     0.03542);   r_f [ 2][ 4] = new RooRealVar( "r_f20",    "r_f4",    0.0005728); 
      r_tt[ 2][ 5] = new RooRealVar( "r_tt21",   "r_tt5",      0.1212);   r_tf[ 2][ 5] = new RooRealVar( "r_tf21",   "r_tf5",     0.02474);   r_f [ 2][ 5] = new RooRealVar( "r_f21",    "r_f5",    0.0005402); 
      r_tt[ 2][ 6] = new RooRealVar( "r_tt22",   "r_tt6",      0.2138);   r_tf[ 2][ 6] = new RooRealVar( "r_tf22",   "r_tf6",      0.1718);   r_f [ 2][ 6] = new RooRealVar( "r_f22",    "r_f6",     0.004651); 
      r_tt[ 2][ 7] = new RooRealVar( "r_tt23",   "r_tt7",      0.3044);   r_tf[ 2][ 7] = new RooRealVar( "r_tf23",   "r_tf7",      0.1008);   r_f [ 2][ 7] = new RooRealVar( "r_f23",    "r_f7",      0.00527); 
    }else if( fl_xsid==3 ){ // for Xs ll
      r_tt[ 0][ 0] = new RooRealVar( "r_tt0",    "r_tt0",       0.206);   r_tf[ 0][ 0] = new RooRealVar( "r_tf0",    "r_tf0",     0.03205);   r_f [ 0][ 0] = new RooRealVar( "r_f0",     "r_f0",    0.0006546); 
      r_tt[ 0][ 1] = new RooRealVar( "r_tt1",    "r_tt1",       0.211);   r_tf[ 0][ 1] = new RooRealVar( "r_tf1",    "r_tf1",     0.03282);   r_f [ 0][ 1] = new RooRealVar( "r_f1",     "r_f1",    0.0006322); 
      r_tt[ 0][ 2] = new RooRealVar( "r_tt2",    "r_tt2",       0.293);   r_tf[ 0][ 2] = new RooRealVar( "r_tf2",    "r_tf2",     0.05893);   r_f [ 0][ 2] = new RooRealVar( "r_f2",     "r_f2",     0.001857); 
      r_tt[ 0][ 3] = new RooRealVar( "r_tt3",    "r_tt3",      0.2844);   r_tf[ 0][ 3] = new RooRealVar( "r_tf3",    "r_tf3",     0.05922);   r_f [ 0][ 3] = new RooRealVar( "r_f3",     "r_f3",     0.001939); 
      r_tt[ 0][ 4] = new RooRealVar( "r_tt4",    "r_tt4",      0.7039);   r_tf[ 0][ 4] = new RooRealVar( "r_tf4",    "r_tf4",      0.2372);   r_f [ 0][ 4] = new RooRealVar( "r_f4",     "r_f4",    0.0007691); 
      r_tt[ 0][ 5] = new RooRealVar( "r_tt5",    "r_tt5",      0.6747);   r_tf[ 0][ 5] = new RooRealVar( "r_tf5",    "r_tf5",      0.2159);   r_f [ 0][ 5] = new RooRealVar( "r_f5",     "r_f5",    0.0007815); 
      r_tt[ 0][ 6] = new RooRealVar( "r_tt6",    "r_tt6",       2.508);   r_tf[ 0][ 6] = new RooRealVar( "r_tf6",    "r_tf6",       1.144);   r_f [ 0][ 6] = new RooRealVar( "r_f6",     "r_f6",     0.001595); 
      r_tt[ 0][ 7] = new RooRealVar( "r_tt7",    "r_tt7",       2.118);   r_tf[ 0][ 7] = new RooRealVar( "r_tf7",    "r_tf7",        1.07);   r_f [ 0][ 7] = new RooRealVar( "r_f7",     "r_f7",     0.001715); 
      r_tt[ 1][ 0] = new RooRealVar( "r_tt8",    "r_tt0",       0.151);   r_tf[ 1][ 0] = new RooRealVar( "r_tf8",    "r_tf0",     0.02568);   r_f [ 1][ 0] = new RooRealVar( "r_f8",     "r_f0",    0.0003534); 
      r_tt[ 1][ 1] = new RooRealVar( "r_tt9",    "r_tt1",      0.1515);   r_tf[ 1][ 1] = new RooRealVar( "r_tf9",    "r_tf1",     0.02806);   r_f [ 1][ 1] = new RooRealVar( "r_f9",     "r_f1",     0.000336); 
      r_tt[ 1][ 2] = new RooRealVar( "r_tt10",   "r_tt2",      0.2052);   r_tf[ 1][ 2] = new RooRealVar( "r_tf10",   "r_tf2",     0.04827);   r_f [ 1][ 2] = new RooRealVar( "r_f10",    "r_f2",     0.001792); 
      r_tt[ 1][ 3] = new RooRealVar( "r_tt11",   "r_tt3",      0.2044);   r_tf[ 1][ 3] = new RooRealVar( "r_tf11",   "r_tf3",      0.0451);   r_f [ 1][ 3] = new RooRealVar( "r_f11",    "r_f3",     0.001712); 
      r_tt[ 1][ 4] = new RooRealVar( "r_tt12",   "r_tt4",      0.4739);   r_tf[ 1][ 4] = new RooRealVar( "r_tf12",   "r_tf4",      0.1644);   r_f [ 1][ 4] = new RooRealVar( "r_f12",    "r_f4",     0.002354); 
      r_tt[ 1][ 5] = new RooRealVar( "r_tt13",   "r_tt5",      0.4569);   r_tf[ 1][ 5] = new RooRealVar( "r_tf13",   "r_tf5",      0.1688);   r_f [ 1][ 5] = new RooRealVar( "r_f13",    "r_f5",     0.002347); 
      r_tt[ 1][ 6] = new RooRealVar( "r_tt14",   "r_tt6",       1.179);   r_tf[ 1][ 6] = new RooRealVar( "r_tf14",   "r_tf6",       0.534);   r_f [ 1][ 6] = new RooRealVar( "r_f14",    "r_f6",     0.001809); 
      r_tt[ 1][ 7] = new RooRealVar( "r_tt15",   "r_tt7",      0.9743);   r_tf[ 1][ 7] = new RooRealVar( "r_tf15",   "r_tf7",      0.5448);   r_f [ 1][ 7] = new RooRealVar( "r_f15",    "r_f7",     0.001951); 
      r_tt[ 2][ 0] = new RooRealVar( "r_tt16",   "r_tt0",      0.1824);   r_tf[ 2][ 0] = new RooRealVar( "r_tf16",   "r_tf0",     0.02934);   r_f [ 2][ 0] = new RooRealVar( "r_f16",    "r_f0",     0.001008); 
      r_tt[ 2][ 1] = new RooRealVar( "r_tt17",   "r_tt1",      0.1857);   r_tf[ 2][ 1] = new RooRealVar( "r_tf17",   "r_tf1",     0.03077);   r_f [ 2][ 1] = new RooRealVar( "r_f17",    "r_f1",    0.0009682); 
      r_tt[ 2][ 2] = new RooRealVar( "r_tt18",   "r_tt2",      0.2455);   r_tf[ 2][ 2] = new RooRealVar( "r_tf18",   "r_tf2",      0.0533);   r_f [ 2][ 2] = new RooRealVar( "r_f18",    "r_f2",     0.003649); 
      r_tt[ 2][ 3] = new RooRealVar( "r_tt19",   "r_tt3",      0.2422);   r_tf[ 2][ 3] = new RooRealVar( "r_tf19",   "r_tf3",     0.05159);   r_f [ 2][ 3] = new RooRealVar( "r_f19",    "r_f3",     0.003651); 
      r_tt[ 2][ 4] = new RooRealVar( "r_tt20",   "r_tt4",       0.525);   r_tf[ 2][ 4] = new RooRealVar( "r_tf20",   "r_tf4",      0.1804);   r_f [ 2][ 4] = new RooRealVar( "r_f20",    "r_f4",     0.003124); 
      r_tt[ 2][ 5] = new RooRealVar( "r_tt21",   "r_tt5",      0.5049);   r_tf[ 2][ 5] = new RooRealVar( "r_tf21",   "r_tf5",      0.1793);   r_f [ 2][ 5] = new RooRealVar( "r_f21",    "r_f5",     0.003129); 
      r_tt[ 2][ 6] = new RooRealVar( "r_tt22",   "r_tt6",       1.606);   r_tf[ 2][ 6] = new RooRealVar( "r_tf22",   "r_tf6",      0.7306);   r_f [ 2][ 6] = new RooRealVar( "r_f22",    "r_f6",     0.003405); 
      r_tt[ 2][ 7] = new RooRealVar( "r_tt23",   "r_tt7",       1.343);   r_tf[ 2][ 7] = new RooRealVar( "r_tf23",   "r_tf7",      0.7134);   r_f [ 2][ 7] = new RooRealVar( "r_f23",    "r_f7",     0.003666);
    }
  }
  ...
  if( Nbin_afb == 14 ){
    ...
    if( fl_xsid==1 ){ // Kll
      cf_slope[ 0][ 0] = new RooRealVar( "cf_0_0", "cf_0_0",   0.897623 );
      cf_slope[ 0][ 1] = new RooRealVar( "cf_0_1", "cf_0_1",    0.92792 );
      cf_slope[ 0][ 2] = new RooRealVar( "cf_0_2", "cf_0_2",   0.990357 );
      cf_slope[ 0][ 3] = new RooRealVar( "cf_0_3", "cf_0_3",   0.973797 );
      cf_slope[ 1][ 0] = new RooRealVar( "cf_1_0", "cf_1_0",   0.764887 );
      cf_slope[ 1][ 1] = new RooRealVar( "cf_1_1", "cf_1_1",   0.865832 );
      ...
      cf_slope[ 0][ 0] = new RooRealVar( "cf_0_0", "cf_0_0",    1.45092 );
      cf_slope[ 0][ 1] = new RooRealVar( "cf_0_1", "cf_0_1",     1.2127 );
      cf_slope[ 0][ 2] = new RooRealVar( "cf_0_2", "cf_0_2",    1.05717 );
      cf_slope[ 0][ 3] = new RooRealVar( "cf_0_3", "cf_0_3",    1.08065 );
      cf_slope[ 1][ 0] = new RooRealVar( "cf_1_0", "cf_1_0",    1.93301 );
      cf_slope[ 1][ 1] = new RooRealVar( "cf_1_1", "cf_1_1",    1.74603 );
      cf_slope[ 1][ 2] = new RooRealVar( "cf_1_2", "cf_1_2",    1.02883 );
      cf_slope[ 1][ 3] = new RooRealVar( "cf_1_3", "cf_1_3",    1.04533 );
    }else if( fl_xsid==3 ){ // Xsll
      cf_slope[ 0][ 0] = new RooRealVar( "cf_0_0", "cf_0_0",    1.52927 );
      cf_slope[ 0][ 1] = new RooRealVar( "cf_0_1", "cf_0_1",    1.25722 );
      cf_slope[ 0][ 2] = new RooRealVar( "cf_0_2", "cf_0_2",    1.05889 );
      cf_slope[ 0][ 3] = new RooRealVar( "cf_0_3", "cf_0_3",    1.05923 );
      cf_slope[ 1][ 0] = new RooRealVar( "cf_1_0", "cf_1_0",    2.16388 );
      cf_slope[ 1][ 1] = new RooRealVar( "cf_1_1", "cf_1_1",    1.85612 );
  ...
  if( Nbin_afb == 14 ){
    ...
    if( fl_xsid==1 ){ // Kll
      ...
      r_peak_cc[ 1][ 3] = new RooRealVar( "r_peak_cc12", "r_peak_cc12", 0 );
      ...
      r_peak_cc[ 1][ 8] = new RooRealVar( "r_peak_cc17", "r_peak_cc17", 0.03 );
      ...
      r_peak_cc[ 2][ 3] = new RooRealVar( "r_peak_cc21", "r_peak_cc21", 0 );
      ...
      r_peak_cc[ 2][ 8] = new RooRealVar( "r_peak_cc26", "r_peak_cc26", 0.08 );
    }else if( fl_xsid==2 ){ // K*ll
      r_peak_cc[ 0][ 0] = new RooRealVar( "r_peak_cc0", "r_peak_cc0", 0 );
      r_peak_cc[ 0][ 1] = new RooRealVar( "r_peak_cc1", "r_peak_cc1", 0 );
      r_peak_cc[ 0][ 2] = new RooRealVar( "r_peak_cc2", "r_peak_cc2", 0.28 );
      r_peak_cc[ 0][ 3] = new RooRealVar( "r_peak_cc3", "r_peak_cc3", 0.42 );
      r_peak_cc[ 0][ 4] = new RooRealVar( "r_peak_cc4", "r_peak_cc4", 0.42 );
      r_peak_cc[ 0][ 5] = new RooRealVar( "r_peak_cc5", "r_peak_cc5", 0.34 );
      r_peak_cc[ 0][ 6] = new RooRealVar( "r_peak_cc6", "r_peak_cc6", 0 );
      r_peak_cc[ 0][ 7] = new RooRealVar( "r_peak_cc7", "r_peak_cc7", 0 );
      r_peak_cc[ 0][ 8] = new RooRealVar( "r_peak_cc8", "r_peak_cc8", 1.46 );
      r_peak_cc[ 1][ 0] = new RooRealVar( "r_peak_cc9", "r_peak_cc9", 0 );
      r_peak_cc[ 1][ 1] = new RooRealVar( "r_peak_cc10", "r_peak_cc10", 0 );
      r_peak_cc[ 1][ 2] = new RooRealVar( "r_peak_cc11", "r_peak_cc11", 0.13 );
      r_peak_cc[ 1][ 3] = new RooRealVar( "r_peak_cc12", "r_peak_cc12", 0.12 );
      ...
      r_peak_cc[ 1][ 8] = new RooRealVar( "r_peak_cc17", "r_peak_cc17", 0.64 );
      r_peak_cc[ 2][ 0] = new RooRealVar( "r_peak_cc18", "r_peak_cc18", 0 );
      r_peak_cc[ 2][ 1] = new RooRealVar( "r_peak_cc19", "r_peak_cc19", 0 );
      r_peak_cc[ 2][ 2] = new RooRealVar( "r_peak_cc20", "r_peak_cc20", 0.41 );
      r_peak_cc[ 2][ 3] = new RooRealVar( "r_peak_cc21", "r_peak_cc21", 0.54 );
      ...
      r_peak_cc[ 2][ 8] = new RooRealVar( "r_peak_cc26", "r_peak_cc26", 2.1 );
    }else if( fl_xsid==3 ){ // Xsll
      r_peak_cc[ 0][ 0] = new RooRealVar( "r_peak_cc0", "r_peak_cc0", 0 );
      r_peak_cc[ 0][ 1] = new RooRealVar( "r_peak_cc1", "r_peak_cc1", 0 );
      r_peak_cc[ 0][ 2] = new RooRealVar( "r_peak_cc2", "r_peak_cc2", 0.57 );
      r_peak_cc[ 0][ 3] = new RooRealVar( "r_peak_cc3", "r_peak_cc3", 0.55 );
      r_peak_cc[ 0][ 4] = new RooRealVar( "r_peak_cc4", "r_peak_cc4", 0.26 );
      r_peak_cc[ 0][ 5] = new RooRealVar( "r_peak_cc5", "r_peak_cc5", 0.25 );
      r_peak_cc[ 0][ 6] = new RooRealVar( "r_peak_cc6", "r_peak_cc6", 0 );
      r_peak_cc[ 0][ 7] = new RooRealVar( "r_peak_cc7", "r_peak_cc7", 0 );
      r_peak_cc[ 0][ 8] = new RooRealVar( "r_peak_cc8", "r_peak_cc8", 1.63 );
      r_peak_cc[ 1][ 0] = new RooRealVar( "r_peak_cc9", "r_peak_cc9", 0 );
      r_peak_cc[ 1][ 1] = new RooRealVar( "r_peak_cc10", "r_peak_cc10", 0.01 );
      r_peak_cc[ 1][ 2] = new RooRealVar( "r_peak_cc11", "r_peak_cc11", 0.29 );
      r_peak_cc[ 1][ 3] = new RooRealVar( "r_peak_cc12", "r_peak_cc12", 0.27 );
      r_peak_cc[ 1][ 4] = new RooRealVar( "r_peak_cc13", "r_peak_cc13", 0.26 );
      r_peak_cc[ 1][ 5] = new RooRealVar( "r_peak_cc14", "r_peak_cc14", 0.23 );
      r_peak_cc[ 1][ 6] = new RooRealVar( "r_peak_cc15", "r_peak_cc15", 0 );
      r_peak_cc[ 1][ 7] = new RooRealVar( "r_peak_cc16", "r_peak_cc16", 0 );
      r_peak_cc[ 1][ 8] = new RooRealVar( "r_peak_cc17", "r_peak_cc17", 1.06 );
      r_peak_cc[ 2][ 0] = new RooRealVar( "r_peak_cc18", "r_peak_cc18", 0 );
      r_peak_cc[ 2][ 1] = new RooRealVar( "r_peak_cc19", "r_peak_cc19", 0.01 );
      r_peak_cc[ 2][ 2] = new RooRealVar( "r_peak_cc20", "r_peak_cc20", 0.86 );
      r_peak_cc[ 2][ 3] = new RooRealVar( "r_peak_cc21", "r_peak_cc21", 0.82 );
      r_peak_cc[ 2][ 4] = new RooRealVar( "r_peak_cc22", "r_peak_cc22", 0.52 );
      r_peak_cc[ 2][ 5] = new RooRealVar( "r_peak_cc23", "r_peak_cc23", 0.48 );
      r_peak_cc[ 2][ 6] = new RooRealVar( "r_peak_cc24", "r_peak_cc24", 0 );
      r_peak_cc[ 2][ 7] = new RooRealVar( "r_peak_cc25", "r_peak_cc25", 0 );
      r_peak_cc[ 2][ 8] = new RooRealVar( "r_peak_cc26", "r_peak_cc26", 2.69 );
    }
  }
  ...
  if( Nbin_afb == 14 ){
    ...
    if( fl_xsid==1 ){ // Kll
      r_peak_double[ 0][ 0] = new RooRealVar( "r_peak_double0", "r_peak_double0", 0.001778/0.273 );
      r_peak_double[ 0][ 1] = new RooRealVar( "r_peak_double1", "r_peak_double1", 0.002126/0.273 );
      r_peak_double[ 0][ 2] = new RooRealVar( "r_peak_double2", "r_peak_double2", 0.003773/0.273 );
      r_peak_double[ 0][ 3] = new RooRealVar( "r_peak_double3", "r_peak_double3", 0.003488/0.273 );
      ...
      r_peak_double[ 0][ 8] = new RooRealVar( "r_peak_double8", "r_peak_double8", 0.0281/0.273 );
      r_peak_double[ 1][ 0] = new RooRealVar( "r_peak_double9", "r_peak_double9", 0.09878/0.273 );
      r_peak_double[ 1][ 1] = new RooRealVar( "r_peak_double10", "r_peak_double10", 0.1133/0.273 );
      r_peak_double[ 1][ 2] = new RooRealVar( "r_peak_double11", "r_peak_double11", 0.1272/0.273 );
      r_peak_double[ 1][ 3] = new RooRealVar( "r_peak_double12", "r_peak_double12", 0.09795/0.273 );
      ...
      r_peak_double[ 1][ 8] = new RooRealVar( "r_peak_double17", "r_peak_double17", 0.9068/0.273 );
      r_peak_double[ 2][ 0] = new RooRealVar( "r_peak_double18", "r_peak_double18", 0.1006/0.273 );
      r_peak_double[ 2][ 1] = new RooRealVar( "r_peak_double19", "r_peak_double19", 0.1154/0.273 );
      r_peak_double[ 2][ 2] = new RooRealVar( "r_peak_double20", "r_peak_double20", 0.131/0.273 );
      r_peak_double[ 2][ 3] = new RooRealVar( "r_peak_double21", "r_peak_double21", 0.1014/0.273 );
      ...
      r_peak_double[ 2][ 8] = new RooRealVar( "r_peak_double26", "r_peak_double26", 0.9349/0.273 );
    }else if( fl_xsid==2 ){ // K*ll
      r_peak_double[ 0][ 0] = new RooRealVar( "r_peak_double0", "r_peak_double0", 0.004916/0.273 );
      r_peak_double[ 0][ 1] = new RooRealVar( "r_peak_double1", "r_peak_double1", 0.005506/0.273 );
      r_peak_double[ 0][ 2] = new RooRealVar( "r_peak_double2", "r_peak_double2", 0.01242/0.273 );
      r_peak_double[ 0][ 3] = new RooRealVar( "r_peak_double3", "r_peak_double3", 0.01123/0.273 );
      ...
      r_peak_double[ 0][ 8] = new RooRealVar( "r_peak_double8", "r_peak_double8", 0.06724/0.273 );
      r_peak_double[ 1][ 0] = new RooRealVar( "r_peak_double9", "r_peak_double9", 0.2768/0.273 );
      r_peak_double[ 1][ 1] = new RooRealVar( "r_peak_double10", "r_peak_double10", 0.2796/0.273 );
      r_peak_double[ 1][ 2] = new RooRealVar( "r_peak_double11", "r_peak_double11", 0.3942/0.273 );
      r_peak_double[ 1][ 3] = new RooRealVar( "r_peak_double12", "r_peak_double12", 0.3149/0.273 );
      ...
      r_peak_double[ 1][ 8] = new RooRealVar( "r_peak_double17", "r_peak_double17", 2.329/0.273 );
      r_peak_double[ 2][ 0] = new RooRealVar( "r_peak_double18", "r_peak_double18", 0.2817/0.273 );
      r_peak_double[ 2][ 1] = new RooRealVar( "r_peak_double19", "r_peak_double19", 0.2851/0.273 );
      r_peak_double[ 2][ 2] = new RooRealVar( "r_peak_double20", "r_peak_double20", 0.4066/0.273 );
      r_peak_double[ 2][ 3] = new RooRealVar( "r_peak_double21", "r_peak_double21", 0.3262/0.273 );
      ...
      r_peak_double[ 2][ 8] = new RooRealVar( "r_peak_double26", "r_peak_double26", 2.397/0.273 );
    }else if( fl_xsid==3 ){ // Xsll
      r_peak_double[ 0][ 0] = new RooRealVar( "r_peak_double0", "r_peak_double0", 0.01024/0.273 );
      r_peak_double[ 0][ 1] = new RooRealVar( "r_peak_double1", "r_peak_double1", 0.01122/0.273 );
      r_peak_double[ 0][ 2] = new RooRealVar( "r_peak_double2", "r_peak_double2", 0.03143/0.273 );
      r_peak_double[ 0][ 3] = new RooRealVar( "r_peak_double3", "r_peak_double3", 0.02611/0.273 );
      ...
      r_peak_double[ 0][ 8] = new RooRealVar( "r_peak_double8", "r_peak_double8", 0.1015/0.273 );
      r_peak_double[ 1][ 0] = new RooRealVar( "r_peak_double9", "r_peak_double9", 1.011/0.273 );
      r_peak_double[ 1][ 1] = new RooRealVar( "r_peak_double10", "r_peak_double10", 1.022/0.273 );
      r_peak_double[ 1][ 2] = new RooRealVar( "r_peak_double11", "r_peak_double11", 1.737/0.273 );
      r_peak_double[ 1][ 3] = new RooRealVar( "r_peak_double12", "r_peak_double12", 1.353/0.273 );
      ...
      r_peak_double[ 1][ 8] = new RooRealVar( "r_peak_double17", "r_peak_double17", 6.709/0.273 );
      r_peak_double[ 2][ 0] = new RooRealVar( "r_peak_double18", "r_peak_double18", 1.021/0.273 );
      r_peak_double[ 2][ 1] = new RooRealVar( "r_peak_double19", "r_peak_double19", 1.034/0.273 );
      r_peak_double[ 2][ 2] = new RooRealVar( "r_peak_double20", "r_peak_double20", 1.769/0.273 );
      r_peak_double[ 2][ 3] = new RooRealVar( "r_peak_double21", "r_peak_double21", 1.379/0.273 );
      ...
      r_peak_double[ 2][ 8] = new RooRealVar( "r_peak_double26", "r_peak_double26", 6.81/0.273 );
    }
  }
  ...
  if( Nbin_afb == 14 ){
    ...
    if( fl_xsid==1 ){ // Kll
      ...
      r_peak_swap[ 0][ 0] = new RooRealVar( "r_peak_swap0", "r_peak_swap0", 5.551e-05 );
      r_peak_swap[ 0][ 1] = new RooRealVar( "r_peak_swap1", "r_peak_swap1", 3.496e-05 );
      r_peak_swap[ 0][ 2] = new RooRealVar( "r_peak_swap2", "r_peak_swap2", 0.01286 );
      r_peak_swap[ 0][ 3] = new RooRealVar( "r_peak_swap3", "r_peak_swap3", 0.007212 );
      ...
      r_peak_swap[ 0][ 6] = new RooRealVar( "r_peak_swap6", "r_peak_swap6", 0 );
      r_peak_swap[ 0][ 7] = new RooRealVar( "r_peak_swap7", "r_peak_swap7", 0 );
      r_peak_swap[ 0][ 8] = new RooRealVar( "r_peak_swap8", "r_peak_swap8", 0.02171 );
      r_peak_swap[ 1][ 0] = new RooRealVar( "r_peak_swap9", "r_peak_swap9", 0 );
      r_peak_swap[ 1][ 1] = new RooRealVar( "r_peak_swap10", "r_peak_swap10", 0.0008623 );
      r_peak_swap[ 1][ 2] = new RooRealVar( "r_peak_swap11", "r_peak_swap11", 0.3611 );
      r_peak_swap[ 1][ 3] = new RooRealVar( "r_peak_swap12", "r_peak_swap12", 0.2763 );
      ...
      r_peak_swap[ 1][ 6] = new RooRealVar( "r_peak_swap15", "r_peak_swap15", 0 );
      r_peak_swap[ 1][ 7] = new RooRealVar( "r_peak_swap16", "r_peak_swap16", 0 );
      r_peak_swap[ 1][ 8] = new RooRealVar( "r_peak_swap17", "r_peak_swap17", 0.7236 );
      r_peak_swap[ 2][ 0] = new RooRealVar( "r_peak_swap18", "r_peak_swap18", 5.551e-05 );
      r_peak_swap[ 2][ 1] = new RooRealVar( "r_peak_swap19", "r_peak_swap19", 0.0008973 );
      r_peak_swap[ 2][ 2] = new RooRealVar( "r_peak_swap20", "r_peak_swap20", 0.374 );
      r_peak_swap[ 2][ 3] = new RooRealVar( "r_peak_swap21", "r_peak_swap21", 0.2835 );
      ...
      r_peak_swap[ 2][ 6] = new RooRealVar( "r_peak_swap24", "r_peak_swap24", 0 );
      r_peak_swap[ 2][ 7] = new RooRealVar( "r_peak_swap25", "r_peak_swap25", 0 );
      r_peak_swap[ 2][ 8] = new RooRealVar( "r_peak_swap26", "r_peak_swap26", 0.7453 );
    }else if( fl_xsid==3 ){ // Xsll
      r_peak_swap[ 0][ 0] = new RooRealVar( "r_peak_swap0", "r_peak_swap0", 0.001715 );
      r_peak_swap[ 0][ 1] = new RooRealVar( "r_peak_swap1", "r_peak_swap1", 0.001667 );
      r_peak_swap[ 0][ 2] = new RooRealVar( "r_peak_swap2", "r_peak_swap2", 0.02948 );
      r_peak_swap[ 0][ 3] = new RooRealVar( "r_peak_swap3", "r_peak_swap3", 0.01578 );
      ...
      r_peak_swap[ 0][ 6] = new RooRealVar( "r_peak_swap6", "r_peak_swap6", 0 );
      r_peak_swap[ 0][ 7] = new RooRealVar( "r_peak_swap7", "r_peak_swap7", 0 );
      r_peak_swap[ 0][ 8] = new RooRealVar( "r_peak_swap8", "r_peak_swap8", 0.05045 );
      r_peak_swap[ 1][ 0] = new RooRealVar( "r_peak_swap9", "r_peak_swap9", 0.05881 );
      r_peak_swap[ 1][ 1] = new RooRealVar( "r_peak_swap10", "r_peak_swap10", 0.07159 );
      r_peak_swap[ 1][ 2] = new RooRealVar( "r_peak_swap11", "r_peak_swap11", 0.6028 );
      r_peak_swap[ 1][ 3] = new RooRealVar( "r_peak_swap12", "r_peak_swap12", 0.6297 );
      ...
      r_peak_swap[ 1][ 6] = new RooRealVar( "r_peak_swap15", "r_peak_swap15", 0 );
      r_peak_swap[ 1][ 7] = new RooRealVar( "r_peak_swap16", "r_peak_swap16", 0 );
      r_peak_swap[ 1][ 8] = new RooRealVar( "r_peak_swap17", "r_peak_swap17", 1.442 );
      r_peak_swap[ 2][ 0] = new RooRealVar( "r_peak_swap18", "r_peak_swap18", 0.06053 );
      r_peak_swap[ 2][ 1] = new RooRealVar( "r_peak_swap19", "r_peak_swap19", 0.07326 );
      r_peak_swap[ 2][ 2] = new RooRealVar( "r_peak_swap20", "r_peak_swap20", 0.6323 );
      r_peak_swap[ 2][ 3] = new RooRealVar( "r_peak_swap21", "r_peak_swap21", 0.6454 );
      ...
      r_peak_swap[ 2][ 6] = new RooRealVar( "r_peak_swap24", "r_peak_swap24", 0 );
      r_peak_swap[ 2][ 7] = new RooRealVar( "r_peak_swap25", "r_peak_swap25", 0 );
      r_peak_swap[ 2][ 8] = new RooRealVar( "r_peak_swap26", "r_peak_swap26", 1.493 );
    }
  }
  ...
  if( flag_save ){
    TFile outfile( Form("pic/%s_fit_bin_dt_mod_xsll_func%d_%dq2.root",  axis, sel_fun, fl_q2bin), "RECREATE" );
    for( Int_t i=0; i<Nroohist; i++ ){
      for( Int_t j=0; j<2; j++ ){ // [hist, fitted hist]
	Int_t k = j + 2*i;
	if( fl_q2bin==0 ) c1[i][j]->Print( Form("pic/%s_fit_bin_dt_mod_xsll_func%d_c1_%d.eps",  axis, sel_fun, k+1) );
	if( fl_q2bin==0 ) c1[i][j]->Write();
      }
    }

    c2->Print( Form("pic/%s_fit_bin_dt_mod_xsll_func%d_%dq2_c2.eps",  axis, sel_fun, fl_q2bin) );
    c2->Write();

    c3->Print( Form("pic/%s_fit_bin_dt_mod_xsll_func%d_%dq2_c3.eps",  axis, sel_fun, fl_q2bin) );
    c3->Write();
    c4->Print( Form("pic/%s_fit_bin_dt_mod_xsll_func%d_%dq2_c4.eps",  axis, sel_fun, fl_q2bin) );
    c4->Write();

...
const Int_t fl_xsid = 3; // 1(K), 2(K*), 3(Xs)
//const Char_t* pdf_dir = "pdf_kll/";    // 1
//const Char_t* pdf_dir = "pdf_kstrll/"; // 2
const Char_t* pdf_dir = "pdf_xsll/";   // 3
...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  for( Int_t i=0; i<Nbin_afb; i++ ){
	...
	if     ( i ==  0 ){
      ...
      // CHANGEEEEE
      if     ( fl_xsid==1 ) sTmp << " && rm_xs==1"; // for kll
      else if( fl_xsid==2 ) sTmp << " && xs_m<1.1 && (rm_xs==101 || rm_xs==110 || rm_xs==1001 || rm_xs==1010)"; // for k*ll
      else if( fl_xsid==3 ) sTmp << " && ( xs_m>1.1 )"; // for xsll
      else   abort();
  ...
  TFile file_scf( Form("%s/Mbc_self_cf2_setA-U.root",pdf_dir) );
  ...
  if( Nbin_afb == 14 ){
    ...
    if( fl_xsid==1 ){ // Kll
      r_tt[ 0][ 0] = new RooRealVar( "r_tt0",    "r_tt0",   0.0008264);   r_tf[ 0][ 0] = new RooRealVar( "r_tf0",    "r_tf0",           0);   r_f [ 0][ 0] = new RooRealVar( "r_f0",     "r_f0",    3.235e-05); 
      r_tt[ 0][ 1] = new RooRealVar( "r_tt1",    "r_tt1",    0.001106);   r_tf[ 0][ 1] = new RooRealVar( "r_tf1",    "r_tf1",           0);   r_f [ 0][ 1] = new RooRealVar( "r_f1",     "r_f1",    5.019e-05); 
      r_tt[ 0][ 2] = new RooRealVar( "r_tt2",    "r_tt2",    0.001587);   r_tf[ 0][ 2] = new RooRealVar( "r_tf2",    "r_tf2",   0.0001121);   r_f [ 0][ 2] = new RooRealVar( "r_f2",     "r_f2",    1.785e-05); 
      r_tt[ 0][ 3] = new RooRealVar( "r_tt3",    "r_tt3",    0.001158);   r_tf[ 0][ 3] = new RooRealVar( "r_tf3",    "r_tf3",   0.0001133);   r_f [ 0][ 3] = new RooRealVar( "r_f3",     "r_f3",    3.012e-05); 
      r_tt[ 0][ 4] = new RooRealVar( "r_tt4",    "r_tt4",   0.0004266);   r_tf[ 0][ 4] = new RooRealVar( "r_tf4",    "r_tf4",    0.001607);   r_f [ 0][ 4] = new RooRealVar( "r_f4",     "r_f4",    1.785e-05); 
      r_tt[ 0][ 5] = new RooRealVar( "r_tt5",    "r_tt5",    0.001071);   r_tf[ 0][ 5] = new RooRealVar( "r_tf5",    "r_tf5",    0.003093);   r_f [ 0][ 5] = new RooRealVar( "r_f5",     "r_f5",    7.808e-06); 
      r_tt[ 0][ 6] = new RooRealVar( "r_tt6",    "r_tt6",     0.01321);   r_tf[ 0][ 6] = new RooRealVar( "r_tf6",    "r_tf6",     0.02696);   r_f [ 0][ 6] = new RooRealVar( "r_f6",     "r_f6",    0.0005923); 
      r_tt[ 0][ 7] = new RooRealVar( "r_tt7",    "r_tt7",    0.009758);   r_tf[ 0][ 7] = new RooRealVar( "r_tf7",    "r_tf7",     0.03476);   r_f [ 0][ 7] = new RooRealVar( "r_f7",     "r_f7",    0.0006972); 
      r_tt[ 1][ 0] = new RooRealVar( "r_tt8",    "r_tt0",   0.0002038);   r_tf[ 1][ 0] = new RooRealVar( "r_tf8",    "r_tf0",           0);   r_f [ 1][ 0] = new RooRealVar( "r_f8",     "r_f0",    1.339e-05); 
      r_tt[ 1][ 1] = new RooRealVar( "r_tt9",    "r_tt1",   0.0001209);   r_tf[ 1][ 1] = new RooRealVar( "r_tf9",    "r_tf1",           0);   r_f [ 1][ 1] = new RooRealVar( "r_f9",     "r_f1",    7.808e-06); 
      r_tt[ 1][ 2] = new RooRealVar( "r_tt10",   "r_tt2",   0.0004354);   r_tf[ 1][ 2] = new RooRealVar( "r_tf10",   "r_tf2",   6.713e-05);   r_f [ 1][ 2] = new RooRealVar( "r_f10",    "r_f2",    1.785e-05); 
      r_tt[ 1][ 3] = new RooRealVar( "r_tt11",   "r_tt3",   0.0006378);   r_tf[ 1][ 3] = new RooRealVar( "r_tf11",   "r_tf3",           0);   r_f [ 1][ 3] = new RooRealVar( "r_f11",    "r_f3",    1.227e-05); 
      r_tt[ 1][ 4] = new RooRealVar( "r_tt12",   "r_tt4",   0.0008794);   r_tf[ 1][ 4] = new RooRealVar( "r_tf12",   "r_tf4",   0.0009256);   r_f [ 1][ 4] = new RooRealVar( "r_f12",    "r_f4",    1.896e-05); 
      r_tt[ 1][ 5] = new RooRealVar( "r_tt13",   "r_tt5",   0.0005846);   r_tf[ 1][ 5] = new RooRealVar( "r_tf13",   "r_tf5",    0.001759);   r_f [ 1][ 5] = new RooRealVar( "r_f13",    "r_f5",    2.231e-05); 
      r_tt[ 1][ 6] = new RooRealVar( "r_tt14",   "r_tt6",    0.006509);   r_tf[ 1][ 6] = new RooRealVar( "r_tf14",   "r_tf6",     0.01651);   r_f [ 1][ 6] = new RooRealVar( "r_f14",    "r_f6",    0.0004752); 
      r_tt[ 1][ 7] = new RooRealVar( "r_tt15",   "r_tt7",    0.005618);   r_tf[ 1][ 7] = new RooRealVar( "r_tf15",   "r_tf7",     0.02015);   r_f [ 1][ 7] = new RooRealVar( "r_f15",    "r_f7",    0.0005164); 
      r_tt[ 2][ 0] = new RooRealVar( "r_tt16",   "r_tt0",   0.0005703);   r_tf[ 2][ 0] = new RooRealVar( "r_tf16",   "r_tf0",           0);   r_f [ 2][ 0] = new RooRealVar( "r_f16",    "r_f0",    4.573e-05); 
      r_tt[ 2][ 1] = new RooRealVar( "r_tt17",   "r_tt1",    0.000699);   r_tf[ 2][ 1] = new RooRealVar( "r_tf17",   "r_tf1",           0);   r_f [ 2][ 1] = new RooRealVar( "r_f17",    "r_f1",      5.8e-05); 
      r_tt[ 2][ 2] = new RooRealVar( "r_tt18",   "r_tt2",   0.0009764);   r_tf[ 2][ 2] = new RooRealVar( "r_tf18",   "r_tf2",   8.841e-05);   r_f [ 2][ 2] = new RooRealVar( "r_f18",    "r_f2",    3.569e-05); 
      r_tt[ 2][ 3] = new RooRealVar( "r_tt19",   "r_tt3",   0.0008841);   r_tf[ 2][ 3] = new RooRealVar( "r_tf19",   "r_tf3",   5.326e-05);   r_f [ 2][ 3] = new RooRealVar( "r_f19",    "r_f3",    4.239e-05); 
      r_tt[ 2][ 4] = new RooRealVar( "r_tt20",   "r_tt4",   0.0007371);   r_tf[ 2][ 4] = new RooRealVar( "r_tf20",   "r_tf4",    0.001139);   r_f [ 2][ 4] = new RooRealVar( "r_f20",    "r_f4",    3.681e-05); 
      r_tt[ 2][ 5] = new RooRealVar( "r_tt21",   "r_tt5",   0.0007367);   r_tf[ 2][ 5] = new RooRealVar( "r_tf21",   "r_tf5",    0.002178);   r_f [ 2][ 5] = new RooRealVar( "r_f21",    "r_f5",    3.012e-05); 
      r_tt[ 2][ 6] = new RooRealVar( "r_tt22",   "r_tt6",     0.00948);   r_tf[ 2][ 6] = new RooRealVar( "r_tf22",   "r_tf6",     0.02116);   r_f [ 2][ 6] = new RooRealVar( "r_f22",    "r_f6",     0.001067); 
      r_tt[ 2][ 7] = new RooRealVar( "r_tt23",   "r_tt7",    0.007459);   r_tf[ 2][ 7] = new RooRealVar( "r_tf23",   "r_tf7",     0.02662);   r_f [ 2][ 7] = new RooRealVar( "r_f23",    "r_f7",     0.001214); 
    }else if( fl_xsid==2 ){ // K*ll
      r_tt[ 0][ 0] = new RooRealVar( "r_tt0",    "r_tt0",     0.05906);   r_tf[ 0][ 0] = new RooRealVar( "r_tf0",    "r_tf0",     0.01284);   r_f [ 0][ 0] = new RooRealVar( "r_f0",     "r_f0",    0.0002352); 
      r_tt[ 0][ 1] = new RooRealVar( "r_tt1",    "r_tt1",     0.05647);   r_tf[ 0][ 1] = new RooRealVar( "r_tf1",    "r_tf1",     0.01302);   r_f [ 0][ 1] = new RooRealVar( "r_f1",     "r_f1",    0.0002911); 
      r_tt[ 0][ 2] = new RooRealVar( "r_tt2",    "r_tt2",     0.07713);   r_tf[ 0][ 2] = new RooRealVar( "r_tf2",    "r_tf2",     0.02087);   r_f [ 0][ 2] = new RooRealVar( "r_f2",     "r_f2",     0.000219); 
      r_tt[ 0][ 3] = new RooRealVar( "r_tt3",    "r_tt3",     0.09158);   r_tf[ 0][ 3] = new RooRealVar( "r_tf3",    "r_tf3",     0.02018);   r_f [ 0][ 3] = new RooRealVar( "r_f3",     "r_f3",     0.000176); 
      r_tt[ 0][ 4] = new RooRealVar( "r_tt4",    "r_tt4",      0.1163);   r_tf[ 0][ 4] = new RooRealVar( "r_tf4",    "r_tf4",     0.04879);   r_f [ 0][ 4] = new RooRealVar( "r_f4",     "r_f4",    0.0001963); 
      r_tt[ 0][ 5] = new RooRealVar( "r_tt5",    "r_tt5",      0.1614);   r_tf[ 0][ 5] = new RooRealVar( "r_tf5",    "r_tf5",     0.03248);   r_f [ 0][ 5] = new RooRealVar( "r_f5",     "r_f5",    0.0001622); 
      r_tt[ 0][ 6] = new RooRealVar( "r_tt6",    "r_tt6",      0.2723);   r_tf[ 0][ 6] = new RooRealVar( "r_tf6",    "r_tf6",      0.2203);   r_f [ 0][ 6] = new RooRealVar( "r_f6",     "r_f6",     0.002255); 
      r_tt[ 0][ 7] = new RooRealVar( "r_tt7",    "r_tt7",      0.3877);   r_tf[ 0][ 7] = new RooRealVar( "r_tf7",    "r_tf7",      0.1288);   r_f [ 0][ 7] = new RooRealVar( "r_f7",     "r_f7",     0.002623); 
      r_tt[ 1][ 0] = new RooRealVar( "r_tt8",    "r_tt0",     0.03649);   r_tf[ 1][ 0] = new RooRealVar( "r_tf8",    "r_tf0",     0.00856);   r_f [ 1][ 0] = new RooRealVar( "r_f8",     "r_f0",    6.488e-05); 
      r_tt[ 1][ 1] = new RooRealVar( "r_tt9",    "r_tt1",     0.03643);   r_tf[ 1][ 1] = new RooRealVar( "r_tf9",    "r_tf1",    0.008591);   r_f [ 1][ 1] = new RooRealVar( "r_f9",     "r_f1",    6.488e-05); 
      r_tt[ 1][ 2] = new RooRealVar( "r_tt10",   "r_tt2",     0.05322);   r_tf[ 1][ 2] = new RooRealVar( "r_tf10",   "r_tf2",     0.01532);   r_f [ 1][ 2] = new RooRealVar( "r_f10",    "r_f2",    0.0001622); 
      r_tt[ 1][ 3] = new RooRealVar( "r_tt11",   "r_tt3",     0.05997);   r_tf[ 1][ 3] = new RooRealVar( "r_tf11",   "r_tf3",     0.01288);   r_f [ 1][ 3] = new RooRealVar( "r_f11",    "r_f3",    0.0001225); 
      r_tt[ 1][ 4] = new RooRealVar( "r_tt12",   "r_tt4",     0.07487);   r_tf[ 1][ 4] = new RooRealVar( "r_tf12",   "r_tf4",     0.02956);   r_f [ 1][ 4] = new RooRealVar( "r_f12",    "r_f4",    0.0003033); 
      r_tt[ 1][ 5] = new RooRealVar( "r_tt13",   "r_tt5",      0.1036);   r_tf[ 1][ 5] = new RooRealVar( "r_tf13",   "r_tf5",     0.02136);   r_f [ 1][ 5] = new RooRealVar( "r_f13",    "r_f5",     0.000309); 
      r_tt[ 1][ 6] = new RooRealVar( "r_tt14",   "r_tt6",      0.1689);   r_tf[ 1][ 6] = new RooRealVar( "r_tf14",   "r_tf6",      0.1342);   r_f [ 1][ 6] = new RooRealVar( "r_f14",    "r_f6",     0.001802); 
      r_tt[ 1][ 7] = new RooRealVar( "r_tt15",   "r_tt7",      0.2398);   r_tf[ 1][ 7] = new RooRealVar( "r_tf15",   "r_tf7",     0.07933);   r_f [ 1][ 7] = new RooRealVar( "r_f15",    "r_f7",     0.001974); 
      r_tt[ 2][ 0] = new RooRealVar( "r_tt16",   "r_tt0",     0.04953);   r_tf[ 2][ 0] = new RooRealVar( "r_tf16",   "r_tf0",      0.0111);   r_f [ 2][ 0] = new RooRealVar( "r_f16",    "r_f0",    0.0003001); 
      r_tt[ 2][ 1] = new RooRealVar( "r_tt17",   "r_tt1",     0.04833);   r_tf[ 2][ 1] = new RooRealVar( "r_tf17",   "r_tf1",     0.01115);   r_f [ 2][ 1] = new RooRealVar( "r_f17",    "r_f1",     0.000356); 
      r_tt[ 2][ 2] = new RooRealVar( "r_tt18",   "r_tt2",     0.06428);   r_tf[ 2][ 2] = new RooRealVar( "r_tf18",   "r_tf2",     0.01789);   r_f [ 2][ 2] = new RooRealVar( "r_f18",    "r_f2",    0.0003812); 
      r_tt[ 2][ 3] = new RooRealVar( "r_tt19",   "r_tt3",     0.07463);   r_tf[ 2][ 3] = new RooRealVar( "r_tf19",   "r_tf3",     0.01625);   r_f [ 2][ 3] = new RooRealVar( "r_f19",    "r_f3",    0.0002984); 
      r_tt[ 2][ 4] = new RooRealVar( "r_tt20",   "r_tt4",     0.08749);   r_tf[ 2][ 4] = new RooRealVar( "r_tf20",   "r_tf4",     0.03542);   r_f [ 2][ 4] = new RooRealVar( "r_f20",    "r_f4",    0.0004996); 
      r_tt[ 2][ 5] = new RooRealVar( "r_tt21",   "r_tt5",      0.1212);   r_tf[ 2][ 5] = new RooRealVar( "r_tf21",   "r_tf5",     0.02474);   r_f [ 2][ 5] = new RooRealVar( "r_f21",    "r_f5",    0.0004712); 
      r_tt[ 2][ 6] = new RooRealVar( "r_tt22",   "r_tt6",      0.2138);   r_tf[ 2][ 6] = new RooRealVar( "r_tf22",   "r_tf6",      0.1718);   r_f [ 2][ 6] = new RooRealVar( "r_f22",    "r_f6",     0.004057); 
      r_tt[ 2][ 7] = new RooRealVar( "r_tt23",   "r_tt7",      0.3044);   r_tf[ 2][ 7] = new RooRealVar( "r_tf23",   "r_tf7",      0.1008);   r_f [ 2][ 7] = new RooRealVar( "r_f23",    "r_f7",     0.004597); 
    }else if( fl_xsid==3 ){ // Xsll
      r_tt[ 0][ 0] = new RooRealVar( "r_tt0",    "r_tt0",      0.2383);   r_tf[ 0][ 0] = new RooRealVar( "r_tf0",    "r_tf0",     0.04302);   r_f [ 0][ 0] = new RooRealVar( "r_f0",     "r_f0",     0.001511); 
      r_tt[ 0][ 1] = new RooRealVar( "r_tt1",    "r_tt1",      0.2395);   r_tf[ 0][ 1] = new RooRealVar( "r_tf1",    "r_tf1",     0.04274);   r_f [ 0][ 1] = new RooRealVar( "r_f1",     "r_f1",     0.001588); 
      r_tt[ 0][ 2] = new RooRealVar( "r_tt2",    "r_tt2",       0.378);   r_tf[ 0][ 2] = new RooRealVar( "r_tf2",    "r_tf2",     0.08911);   r_f [ 0][ 2] = new RooRealVar( "r_f2",     "r_f2",     0.001101); 
      r_tt[ 0][ 3] = new RooRealVar( "r_tt3",    "r_tt3",      0.3671);   r_tf[ 0][ 3] = new RooRealVar( "r_tf3",    "r_tf3",     0.08936);   r_f [ 0][ 3] = new RooRealVar( "r_f3",     "r_f3",     0.001084); 
      r_tt[ 0][ 4] = new RooRealVar( "r_tt4",    "r_tt4",      0.7039);   r_tf[ 0][ 4] = new RooRealVar( "r_tf4",    "r_tf4",      0.2372);   r_f [ 0][ 4] = new RooRealVar( "r_f4",     "r_f4",    0.0006492); 
      r_tt[ 0][ 5] = new RooRealVar( "r_tt5",    "r_tt5",      0.6747);   r_tf[ 0][ 5] = new RooRealVar( "r_tf5",    "r_tf5",      0.2159);   r_f [ 0][ 5] = new RooRealVar( "r_f5",     "r_f5",    0.0006597); 
      r_tt[ 0][ 6] = new RooRealVar( "r_tt6",    "r_tt6",       2.508);   r_tf[ 0][ 6] = new RooRealVar( "r_tf6",    "r_tf6",       1.144);   r_f [ 0][ 6] = new RooRealVar( "r_f6",     "r_f6",     0.001347); 
      r_tt[ 0][ 7] = new RooRealVar( "r_tt7",    "r_tt7",       2.118);   r_tf[ 0][ 7] = new RooRealVar( "r_tf7",    "r_tf7",        1.07);   r_f [ 0][ 7] = new RooRealVar( "r_f7",     "r_f7",     0.001448); 
      r_tt[ 1][ 0] = new RooRealVar( "r_tt8",    "r_tt0",       0.173);   r_tf[ 1][ 0] = new RooRealVar( "r_tf8",    "r_tf0",     0.03589);   r_f [ 1][ 0] = new RooRealVar( "r_f8",     "r_f0",     0.001143); 
      r_tt[ 1][ 1] = new RooRealVar( "r_tt9",    "r_tt1",      0.1749);   r_tf[ 1][ 1] = new RooRealVar( "r_tf9",    "r_tf1",     0.03408);   r_f [ 1][ 1] = new RooRealVar( "r_f9",     "r_f1",     0.001101); 
      r_tt[ 1][ 2] = new RooRealVar( "r_tt10",   "r_tt2",      0.2708);   r_tf[ 1][ 2] = new RooRealVar( "r_tf10",   "r_tf2",     0.07322);   r_f [ 1][ 2] = new RooRealVar( "r_f10",    "r_f2",      0.00208); 
      r_tt[ 1][ 3] = new RooRealVar( "r_tt11",   "r_tt3",      0.2686);   r_tf[ 1][ 3] = new RooRealVar( "r_tf11",   "r_tf3",     0.07282);   r_f [ 1][ 3] = new RooRealVar( "r_f11",    "r_f3",     0.001742); 
      r_tt[ 1][ 4] = new RooRealVar( "r_tt12",   "r_tt4",      0.4739);   r_tf[ 1][ 4] = new RooRealVar( "r_tf12",   "r_tf4",      0.1644);   r_f [ 1][ 4] = new RooRealVar( "r_f12",    "r_f4",     0.001987); 
      r_tt[ 1][ 5] = new RooRealVar( "r_tt13",   "r_tt5",      0.4569);   r_tf[ 1][ 5] = new RooRealVar( "r_tf13",   "r_tf5",      0.1688);   r_f [ 1][ 5] = new RooRealVar( "r_f13",    "r_f5",     0.001981); 
      r_tt[ 1][ 6] = new RooRealVar( "r_tt14",   "r_tt6",       1.179);   r_tf[ 1][ 6] = new RooRealVar( "r_tf14",   "r_tf6",       0.534);   r_f [ 1][ 6] = new RooRealVar( "r_f14",    "r_f6",     0.001527); 
      r_tt[ 1][ 7] = new RooRealVar( "r_tt15",   "r_tt7",      0.9743);   r_tf[ 1][ 7] = new RooRealVar( "r_tf15",   "r_tf7",      0.5448);   r_f [ 1][ 7] = new RooRealVar( "r_f15",    "r_f7",     0.001647); 
      r_tt[ 2][ 0] = new RooRealVar( "r_tt16",   "r_tt0",      0.2065);   r_tf[ 2][ 0] = new RooRealVar( "r_tf16",   "r_tf0",     0.03963);   r_f [ 2][ 0] = new RooRealVar( "r_f16",    "r_f0",     0.002653); 
      r_tt[ 2][ 1] = new RooRealVar( "r_tt17",   "r_tt1",      0.2088);   r_tf[ 2][ 1] = new RooRealVar( "r_tf17",   "r_tf1",     0.03852);   r_f [ 2][ 1] = new RooRealVar( "r_f17",    "r_f1",     0.002689); 
      r_tt[ 2][ 2] = new RooRealVar( "r_tt18",   "r_tt2",      0.3087);   r_tf[ 2][ 2] = new RooRealVar( "r_tf18",   "r_tf2",     0.07889);   r_f [ 2][ 2] = new RooRealVar( "r_f18",    "r_f2",     0.003181); 
      r_tt[ 2][ 3] = new RooRealVar( "r_tt19",   "r_tt3",      0.3037);   r_tf[ 2][ 3] = new RooRealVar( "r_tf19",   "r_tf3",     0.07866);   r_f [ 2][ 3] = new RooRealVar( "r_f19",    "r_f3",     0.002826); 
      r_tt[ 2][ 4] = new RooRealVar( "r_tt20",   "r_tt4",       0.525);   r_tf[ 2][ 4] = new RooRealVar( "r_tf20",   "r_tf4",      0.1804);   r_f [ 2][ 4] = new RooRealVar( "r_f20",    "r_f4",     0.002637); 
      r_tt[ 2][ 5] = new RooRealVar( "r_tt21",   "r_tt5",      0.5049);   r_tf[ 2][ 5] = new RooRealVar( "r_tf21",   "r_tf5",      0.1793);   r_f [ 2][ 5] = new RooRealVar( "r_f21",    "r_f5",     0.002641); 
      r_tt[ 2][ 6] = new RooRealVar( "r_tt22",   "r_tt6",       1.606);   r_tf[ 2][ 6] = new RooRealVar( "r_tf22",   "r_tf6",      0.7306);   r_f [ 2][ 6] = new RooRealVar( "r_f22",    "r_f6",     0.002874); 
      r_tt[ 2][ 7] = new RooRealVar( "r_tt23",   "r_tt7",       1.343);   r_tf[ 2][ 7] = new RooRealVar( "r_tf23",   "r_tf7",      0.7134);   r_f [ 2][ 7] = new RooRealVar( "r_f23",    "r_f7",     0.003095); 
    }
  }
  ...
  if( Nbin_afb == 14 ){
    ...
    if( fl_xsid==1 ){ // Kll
      cf_slope[ 0][ 0] = new RooRealVar( "cf_0_0", "cf_0_0",   0.936379 );
      cf_slope[ 0][ 1] = new RooRealVar( "cf_0_1", "cf_0_1",    1.00136 );
      cf_slope[ 0][ 2] = new RooRealVar( "cf_0_2", "cf_0_2",   0.990357 );
      cf_slope[ 0][ 3] = new RooRealVar( "cf_0_3", "cf_0_3",   0.973797 );
      cf_slope[ 1][ 0] = new RooRealVar( "cf_1_0", "cf_1_0",   0.844285 );
      cf_slope[ 1][ 1] = new RooRealVar( "cf_1_1", "cf_1_1",   0.965014 );
      cf_slope[ 1][ 2] = new RooRealVar( "cf_1_2", "cf_1_2",    1.00524 );
      cf_slope[ 1][ 3] = new RooRealVar( "cf_1_3", "cf_1_3",   0.969081 );
    }else if( fl_xsid==2 ){ // K*ll
      cf_slope[ 0][ 0] = new RooRealVar( "cf_0_0", "cf_0_0",    1.22527 );
      cf_slope[ 0][ 1] = new RooRealVar( "cf_0_1", "cf_0_1",    1.12444 );
      cf_slope[ 0][ 2] = new RooRealVar( "cf_0_2", "cf_0_2",    1.05717 );
      cf_slope[ 0][ 3] = new RooRealVar( "cf_0_3", "cf_0_3",    1.08065 );
      cf_slope[ 1][ 0] = new RooRealVar( "cf_1_0", "cf_1_0",    1.95184 );
      cf_slope[ 1][ 1] = new RooRealVar( "cf_1_1", "cf_1_1",    1.32423 );
      cf_slope[ 1][ 2] = new RooRealVar( "cf_1_2", "cf_1_2",    1.02883 );
      cf_slope[ 1][ 3] = new RooRealVar( "cf_1_3", "cf_1_3",    1.04533 );
    }else if( fl_xsid==3 ){ // Xsll
      cf_slope[ 0][ 0] = new RooRealVar( "cf_0_0", "cf_0_0",    1.28136 );
      cf_slope[ 0][ 1] = new RooRealVar( "cf_0_1", "cf_0_1",     1.1354 );
      cf_slope[ 0][ 2] = new RooRealVar( "cf_0_2", "cf_0_2",    1.05889 );
      cf_slope[ 0][ 3] = new RooRealVar( "cf_0_3", "cf_0_3",    1.05923 );
      cf_slope[ 1][ 0] = new RooRealVar( "cf_1_0", "cf_1_0",    2.06977 );
      cf_slope[ 1][ 1] = new RooRealVar( "cf_1_1", "cf_1_1",    1.37259 );
      cf_slope[ 1][ 2] = new RooRealVar( "cf_1_2", "cf_1_2",    1.03105 );
      cf_slope[ 1][ 3] = new RooRealVar( "cf_1_3", "cf_1_3",    1.03187 );
    }
 }
  ...
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  // READ PDF (charmonium)
  //TFile file_cc( Form("%s/Mbc_peak_cc2_s00-5.root",pdf_dir) ); // gMC
  TFile file_cc( Form("%s/Mbc_peak_cc2_s00.root",pdf_dir) ); // CC-MC
  ...
  if( Nbin_afb == 14 ){
    ...
    // CC-MC
    if( fl_xsid==1 ){ // Kll
      r_peak_cc[ 0][ 0] = new RooRealVar( "r_peak_cc0", "r_peak_cc0", 0 );
      r_peak_cc[ 0][ 1] = new RooRealVar( "r_peak_cc1", "r_peak_cc1", 0 );
      r_peak_cc[ 0][ 2] = new RooRealVar( "r_peak_cc2", "r_peak_cc2", 0 );
      r_peak_cc[ 0][ 3] = new RooRealVar( "r_peak_cc3", "r_peak_cc3", 0 );
      r_peak_cc[ 0][ 4] = new RooRealVar( "r_peak_cc4", "r_peak_cc4", 0.03 );
      r_peak_cc[ 0][ 5] = new RooRealVar( "r_peak_cc5", "r_peak_cc5", 0.02 );
      r_peak_cc[ 0][ 6] = new RooRealVar( "r_peak_cc6", "r_peak_cc6", 0 );
      r_peak_cc[ 0][ 7] = new RooRealVar( "r_peak_cc7", "r_peak_cc7", 0 );
      r_peak_cc[ 0][ 8] = new RooRealVar( "r_peak_cc8", "r_peak_cc8", 0.05 );
      r_peak_cc[ 1][ 0] = new RooRealVar( "r_peak_cc9", "r_peak_cc9", 0 );
      r_peak_cc[ 1][ 1] = new RooRealVar( "r_peak_cc10", "r_peak_cc10", 0 );
      r_peak_cc[ 1][ 2] = new RooRealVar( "r_peak_cc11", "r_peak_cc11", 0 );
      r_peak_cc[ 1][ 3] = new RooRealVar( "r_peak_cc12", "r_peak_cc12", 0.01 );
      r_peak_cc[ 1][ 4] = new RooRealVar( "r_peak_cc13", "r_peak_cc13", 0.01 );
      r_peak_cc[ 1][ 5] = new RooRealVar( "r_peak_cc14", "r_peak_cc14", 0 );
      r_peak_cc[ 1][ 6] = new RooRealVar( "r_peak_cc15", "r_peak_cc15", 0.01 );
      r_peak_cc[ 1][ 7] = new RooRealVar( "r_peak_cc16", "r_peak_cc16", 0.01 );
      r_peak_cc[ 1][ 8] = new RooRealVar( "r_peak_cc17", "r_peak_cc17", 0.04 );
      r_peak_cc[ 2][ 0] = new RooRealVar( "r_peak_cc18", "r_peak_cc18", 0 );
      r_peak_cc[ 2][ 1] = new RooRealVar( "r_peak_cc19", "r_peak_cc19", 0 );
      r_peak_cc[ 2][ 2] = new RooRealVar( "r_peak_cc20", "r_peak_cc20", 0 );
      r_peak_cc[ 2][ 3] = new RooRealVar( "r_peak_cc21", "r_peak_cc21", 0.01 );
      r_peak_cc[ 2][ 4] = new RooRealVar( "r_peak_cc22", "r_peak_cc22", 0.04 );
      r_peak_cc[ 2][ 5] = new RooRealVar( "r_peak_cc23", "r_peak_cc23", 0.02 );
      r_peak_cc[ 2][ 6] = new RooRealVar( "r_peak_cc24", "r_peak_cc24", 0.01 );
      r_peak_cc[ 2][ 7] = new RooRealVar( "r_peak_cc25", "r_peak_cc25", 0.01 );
      r_peak_cc[ 2][ 8] = new RooRealVar( "r_peak_cc26", "r_peak_cc26", 0.09 );
    }else if( fl_xsid==2 ){ // K*ll
      r_peak_cc[ 0][ 0] = new RooRealVar( "r_peak_cc0", "r_peak_cc0", 0.05 );
      r_peak_cc[ 0][ 1] = new RooRealVar( "r_peak_cc1", "r_peak_cc1", 0.04 );
      r_peak_cc[ 0][ 2] = new RooRealVar( "r_peak_cc2", "r_peak_cc2", 1.17 );
      r_peak_cc[ 0][ 3] = new RooRealVar( "r_peak_cc3", "r_peak_cc3", 1.24 );
      r_peak_cc[ 0][ 4] = new RooRealVar( "r_peak_cc4", "r_peak_cc4", 0.42 );
      r_peak_cc[ 0][ 5] = new RooRealVar( "r_peak_cc5", "r_peak_cc5", 0.34 );
      r_peak_cc[ 0][ 6] = new RooRealVar( "r_peak_cc6", "r_peak_cc6", 0 );
      r_peak_cc[ 0][ 7] = new RooRealVar( "r_peak_cc7", "r_peak_cc7", 0 );
      r_peak_cc[ 0][ 8] = new RooRealVar( "r_peak_cc8", "r_peak_cc8", 3.26 );
      r_peak_cc[ 1][ 0] = new RooRealVar( "r_peak_cc9", "r_peak_cc9", 0.03 );
      r_peak_cc[ 1][ 1] = new RooRealVar( "r_peak_cc10", "r_peak_cc10", 0.03 );
      r_peak_cc[ 1][ 2] = new RooRealVar( "r_peak_cc11", "r_peak_cc11", 1.31 );
      r_peak_cc[ 1][ 3] = new RooRealVar( "r_peak_cc12", "r_peak_cc12", 1.28 );
      r_peak_cc[ 1][ 4] = new RooRealVar( "r_peak_cc13", "r_peak_cc13", 0.18 );
      r_peak_cc[ 1][ 5] = new RooRealVar( "r_peak_cc14", "r_peak_cc14", 0.21 );
      r_peak_cc[ 1][ 6] = new RooRealVar( "r_peak_cc15", "r_peak_cc15", 0 );
      r_peak_cc[ 1][ 7] = new RooRealVar( "r_peak_cc16", "r_peak_cc16", 0 );
      r_peak_cc[ 1][ 8] = new RooRealVar( "r_peak_cc17", "r_peak_cc17", 3.04 );
      r_peak_cc[ 2][ 0] = new RooRealVar( "r_peak_cc18", "r_peak_cc18", 0.08 );
      r_peak_cc[ 2][ 1] = new RooRealVar( "r_peak_cc19", "r_peak_cc19", 0.07 );
      r_peak_cc[ 2][ 2] = new RooRealVar( "r_peak_cc20", "r_peak_cc20", 2.48 );
      r_peak_cc[ 2][ 3] = new RooRealVar( "r_peak_cc21", "r_peak_cc21", 2.52 );
      r_peak_cc[ 2][ 4] = new RooRealVar( "r_peak_cc22", "r_peak_cc22", 0.6 );
      r_peak_cc[ 2][ 5] = new RooRealVar( "r_peak_cc23", "r_peak_cc23", 0.55 );
      r_peak_cc[ 2][ 6] = new RooRealVar( "r_peak_cc24", "r_peak_cc24", 0 );
      r_peak_cc[ 2][ 7] = new RooRealVar( "r_peak_cc25", "r_peak_cc25", 0 );
      r_peak_cc[ 2][ 8] = new RooRealVar( "r_peak_cc26", "r_peak_cc26", 6.3 );
    }else if( fl_xsid==3 ){ // Xsll
      r_peak_cc[ 0][ 0] = new RooRealVar( "r_peak_cc0", "r_peak_cc0", 0.03 );
      r_peak_cc[ 0][ 1] = new RooRealVar( "r_peak_cc1", "r_peak_cc1", 0.04 );
      r_peak_cc[ 0][ 2] = new RooRealVar( "r_peak_cc2", "r_peak_cc2", 2.26 );
      r_peak_cc[ 0][ 3] = new RooRealVar( "r_peak_cc3", "r_peak_cc3", 2.03 );
      r_peak_cc[ 0][ 4] = new RooRealVar( "r_peak_cc4", "r_peak_cc4", 0.26 );
      r_peak_cc[ 0][ 5] = new RooRealVar( "r_peak_cc5", "r_peak_cc5", 0.25 );
      r_peak_cc[ 0][ 6] = new RooRealVar( "r_peak_cc6", "r_peak_cc6", 0 );
      r_peak_cc[ 0][ 7] = new RooRealVar( "r_peak_cc7", "r_peak_cc7", 0 );
      r_peak_cc[ 0][ 8] = new RooRealVar( "r_peak_cc8", "r_peak_cc8", 4.87 );
      r_peak_cc[ 1][ 0] = new RooRealVar( "r_peak_cc9", "r_peak_cc9", 0.03 );
      r_peak_cc[ 1][ 1] = new RooRealVar( "r_peak_cc10", "r_peak_cc10", 0.07 );
      r_peak_cc[ 1][ 2] = new RooRealVar( "r_peak_cc11", "r_peak_cc11", 3.55 );
      r_peak_cc[ 1][ 3] = new RooRealVar( "r_peak_cc12", "r_peak_cc12", 3.6 );
      r_peak_cc[ 1][ 4] = new RooRealVar( "r_peak_cc13", "r_peak_cc13", 0.26 );
      r_peak_cc[ 1][ 5] = new RooRealVar( "r_peak_cc14", "r_peak_cc14", 0.23 );
      r_peak_cc[ 1][ 6] = new RooRealVar( "r_peak_cc15", "r_peak_cc15", 0 );
      r_peak_cc[ 1][ 7] = new RooRealVar( "r_peak_cc16", "r_peak_cc16", 0 );
      r_peak_cc[ 1][ 8] = new RooRealVar( "r_peak_cc17", "r_peak_cc17", 7.74 );
      r_peak_cc[ 2][ 0] = new RooRealVar( "r_peak_cc18", "r_peak_cc18", 0.06 );
      r_peak_cc[ 2][ 1] = new RooRealVar( "r_peak_cc19", "r_peak_cc19", 0.11 );
      r_peak_cc[ 2][ 2] = new RooRealVar( "r_peak_cc20", "r_peak_cc20", 5.81 );
      r_peak_cc[ 2][ 3] = new RooRealVar( "r_peak_cc21", "r_peak_cc21", 5.63 );
      r_peak_cc[ 2][ 4] = new RooRealVar( "r_peak_cc22", "r_peak_cc22", 0.52 );
      r_peak_cc[ 2][ 5] = new RooRealVar( "r_peak_cc23", "r_peak_cc23", 0.48 );
      r_peak_cc[ 2][ 6] = new RooRealVar( "r_peak_cc24", "r_peak_cc24", 0 );
      r_peak_cc[ 2][ 7] = new RooRealVar( "r_peak_cc25", "r_peak_cc25", 0 );
      r_peak_cc[ 2][ 8] = new RooRealVar( "r_peak_cc26", "r_peak_cc26", 12.61 );
    }
  }

  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  // READ PDF (double miss-PID)
  TFile file_double( Form("%s/Mbc_peak_double2_s00.root",pdf_dir) ); // RD
  ...
  if( Nbin_afb == 14 ){
    ...
    if( fl_xsid==1 ){ // Kll
      r_peak_double[ 0][ 0] = new RooRealVar( "r_peak_double0", "r_peak_double0", 0.004511/0.273 );
      r_peak_double[ 0][ 1] = new RooRealVar( "r_peak_double1", "r_peak_double1", 0.004926/0.273 );
      r_peak_double[ 0][ 2] = new RooRealVar( "r_peak_double2", "r_peak_double2", 0.001818/0.273 );
      r_peak_double[ 0][ 3] = new RooRealVar( "r_peak_double3", "r_peak_double3", 0.001108/0.273 );
      r_peak_double[ 0][ 4] = new RooRealVar( "r_peak_double4", "r_peak_double4", 0.00103/0.273 );
      r_peak_double[ 0][ 5] = new RooRealVar( "r_peak_double5", "r_peak_double5", 0.0003903/0.273 );
      r_peak_double[ 0][ 6] = new RooRealVar( "r_peak_double6", "r_peak_double6", 0.0104/0.273 );
      r_peak_double[ 0][ 7] = new RooRealVar( "r_peak_double7", "r_peak_double7", 0.005111/0.273 );
      r_peak_double[ 0][ 8] = new RooRealVar( "r_peak_double8", "r_peak_double8", 0.02929/0.273 );
      r_peak_double[ 1][ 0] = new RooRealVar( "r_peak_double9", "r_peak_double9", 0.1841/0.273 );
      r_peak_double[ 1][ 1] = new RooRealVar( "r_peak_double10", "r_peak_double10", 0.1922/0.273 );
      r_peak_double[ 1][ 2] = new RooRealVar( "r_peak_double11", "r_peak_double11", 0.1165/0.273 );
      r_peak_double[ 1][ 3] = new RooRealVar( "r_peak_double12", "r_peak_double12", 0.04521/0.273 );
      r_peak_double[ 1][ 4] = new RooRealVar( "r_peak_double13", "r_peak_double13", 0.08291/0.273 );
      r_peak_double[ 1][ 5] = new RooRealVar( "r_peak_double14", "r_peak_double14", 0.02465/0.273 );
      r_peak_double[ 1][ 6] = new RooRealVar( "r_peak_double15", "r_peak_double15", 0.2496/0.273 );
      r_peak_double[ 1][ 7] = new RooRealVar( "r_peak_double16", "r_peak_double16", 0.1125/0.273 );
      r_peak_double[ 1][ 8] = new RooRealVar( "r_peak_double17", "r_peak_double17", 1.008/0.273 );
      r_peak_double[ 2][ 0] = new RooRealVar( "r_peak_double18", "r_peak_double18", 0.1886/0.273 );
      r_peak_double[ 2][ 1] = new RooRealVar( "r_peak_double19", "r_peak_double19", 0.1971/0.273 );
      r_peak_double[ 2][ 2] = new RooRealVar( "r_peak_double20", "r_peak_double20", 0.1184/0.273 );
      r_peak_double[ 2][ 3] = new RooRealVar( "r_peak_double21", "r_peak_double21", 0.04632/0.273 );
      r_peak_double[ 2][ 4] = new RooRealVar( "r_peak_double22", "r_peak_double22", 0.08394/0.273 );
      r_peak_double[ 2][ 5] = new RooRealVar( "r_peak_double23", "r_peak_double23", 0.02504/0.273 );
      r_peak_double[ 2][ 6] = new RooRealVar( "r_peak_double24", "r_peak_double24", 0.26/0.273 );
      r_peak_double[ 2][ 7] = new RooRealVar( "r_peak_double25", "r_peak_double25", 0.1176/0.273 );
      r_peak_double[ 2][ 8] = new RooRealVar( "r_peak_double26", "r_peak_double26", 1.037/0.273 );
    }else if( fl_xsid==2 ){ // K*ll
      r_peak_double[ 0][ 0] = new RooRealVar( "r_peak_double0", "r_peak_double0", 0.01375/0.273 );
      r_peak_double[ 0][ 1] = new RooRealVar( "r_peak_double1", "r_peak_double1", 0.01413/0.273 );
      r_peak_double[ 0][ 2] = new RooRealVar( "r_peak_double2", "r_peak_double2", 0.006261/0.273 );
      r_peak_double[ 0][ 3] = new RooRealVar( "r_peak_double3", "r_peak_double3", 0.004255/0.273 );
      r_peak_double[ 0][ 4] = new RooRealVar( "r_peak_double4", "r_peak_double4", 0.003919/0.273 );
      r_peak_double[ 0][ 5] = new RooRealVar( "r_peak_double5", "r_peak_double5", 0.00183/0.273 );
      r_peak_double[ 0][ 6] = new RooRealVar( "r_peak_double6", "r_peak_double6", 0.01648/0.273 );
      r_peak_double[ 0][ 7] = new RooRealVar( "r_peak_double7", "r_peak_double7", 0.01095/0.273 );
      r_peak_double[ 0][ 8] = new RooRealVar( "r_peak_double8", "r_peak_double8", 0.07156/0.273 );
      r_peak_double[ 1][ 0] = new RooRealVar( "r_peak_double9", "r_peak_double9", 0.5391/0.273 );
      r_peak_double[ 1][ 1] = new RooRealVar( "r_peak_double10", "r_peak_double10", 0.5242/0.273 );
      r_peak_double[ 1][ 2] = new RooRealVar( "r_peak_double11", "r_peak_double11", 0.3721/0.273 );
      r_peak_double[ 1][ 3] = new RooRealVar( "r_peak_double12", "r_peak_double12", 0.1875/0.273 );
      r_peak_double[ 1][ 4] = new RooRealVar( "r_peak_double13", "r_peak_double13", 0.2571/0.273 );
      r_peak_double[ 1][ 5] = new RooRealVar( "r_peak_double14", "r_peak_double14", 0.1115/0.273 );
      r_peak_double[ 1][ 6] = new RooRealVar( "r_peak_double15", "r_peak_double15", 0.4387/0.273 );
      r_peak_double[ 1][ 7] = new RooRealVar( "r_peak_double16", "r_peak_double16", 0.2566/0.273 );
      r_peak_double[ 1][ 8] = new RooRealVar( "r_peak_double17", "r_peak_double17", 2.687/0.273 );
      r_peak_double[ 2][ 0] = new RooRealVar( "r_peak_double18", "r_peak_double18", 0.5529/0.273 );
      r_peak_double[ 2][ 1] = new RooRealVar( "r_peak_double19", "r_peak_double19", 0.5383/0.273 );
      r_peak_double[ 2][ 2] = new RooRealVar( "r_peak_double20", "r_peak_double20", 0.3784/0.273 );
      r_peak_double[ 2][ 3] = new RooRealVar( "r_peak_double21", "r_peak_double21", 0.1918/0.273 );
      r_peak_double[ 2][ 4] = new RooRealVar( "r_peak_double22", "r_peak_double22", 0.2611/0.273 );
      r_peak_double[ 2][ 5] = new RooRealVar( "r_peak_double23", "r_peak_double23", 0.1133/0.273 );
      r_peak_double[ 2][ 6] = new RooRealVar( "r_peak_double24", "r_peak_double24", 0.4551/0.273 );
      r_peak_double[ 2][ 7] = new RooRealVar( "r_peak_double25", "r_peak_double25", 0.2675/0.273 );
      r_peak_double[ 2][ 8] = new RooRealVar( "r_peak_double26", "r_peak_double26", 2.758/0.273 );
    }else if( fl_xsid==3 ){ // Xsll
      r_peak_double[ 0][ 0] = new RooRealVar( "r_peak_double0", "r_peak_double0", 0.03238/0.273 );
      r_peak_double[ 0][ 1] = new RooRealVar( "r_peak_double1", "r_peak_double1", 0.03087/0.273 );
      r_peak_double[ 0][ 2] = new RooRealVar( "r_peak_double2", "r_peak_double2", 0.01674/0.273 );
      r_peak_double[ 0][ 3] = new RooRealVar( "r_peak_double3", "r_peak_double3", 0.01128/0.273 );
      r_peak_double[ 0][ 4] = new RooRealVar( "r_peak_double4", "r_peak_double4", 0.007731/0.273 );
      r_peak_double[ 0][ 5] = new RooRealVar( "r_peak_double5", "r_peak_double5", 0.005261/0.273 );
      r_peak_double[ 0][ 6] = new RooRealVar( "r_peak_double6", "r_peak_double6", 0.005543/0.273 );
      r_peak_double[ 0][ 7] = new RooRealVar( "r_peak_double7", "r_peak_double7", 0.003988/0.273 );
      r_peak_double[ 0][ 8] = new RooRealVar( "r_peak_double8", "r_peak_double8", 0.1138/0.273 );
      r_peak_double[ 1][ 0] = new RooRealVar( "r_peak_double9", "r_peak_double9", 2.105/0.273 );
      r_peak_double[ 1][ 1] = new RooRealVar( "r_peak_double10", "r_peak_double10", 1.975/0.273 );
      r_peak_double[ 1][ 2] = new RooRealVar( "r_peak_double11", "r_peak_double11", 1.889/0.273 );
      r_peak_double[ 1][ 3] = new RooRealVar( "r_peak_double12", "r_peak_double12", 1.087/0.273 );
      r_peak_double[ 1][ 4] = new RooRealVar( "r_peak_double13", "r_peak_double13", 0.7795/0.273 );
      r_peak_double[ 1][ 5] = new RooRealVar( "r_peak_double14", "r_peak_double14", 0.4973/0.273 );
      r_peak_double[ 1][ 6] = new RooRealVar( "r_peak_double15", "r_peak_double15", 0.1747/0.273 );
      r_peak_double[ 1][ 7] = new RooRealVar( "r_peak_double16", "r_peak_double16", 0.1335/0.273 );
      r_peak_double[ 1][ 8] = new RooRealVar( "r_peak_double17", "r_peak_double17", 8.641/0.273 );
      r_peak_double[ 2][ 0] = new RooRealVar( "r_peak_double18", "r_peak_double18", 2.138/0.273 );
      r_peak_double[ 2][ 1] = new RooRealVar( "r_peak_double19", "r_peak_double19", 2.006/0.273 );
      r_peak_double[ 2][ 2] = new RooRealVar( "r_peak_double20", "r_peak_double20", 1.906/0.273 );
      r_peak_double[ 2][ 3] = new RooRealVar( "r_peak_double21", "r_peak_double21", 1.098/0.273 );
      r_peak_double[ 2][ 4] = new RooRealVar( "r_peak_double22", "r_peak_double22", 0.7873/0.273 );
      r_peak_double[ 2][ 5] = new RooRealVar( "r_peak_double23", "r_peak_double23", 0.5025/0.273 );
      r_peak_double[ 2][ 6] = new RooRealVar( "r_peak_double24", "r_peak_double24", 0.1803/0.273 );
      r_peak_double[ 2][ 7] = new RooRealVar( "r_peak_double25", "r_peak_double25", 0.1375/0.273 );
      r_peak_double[ 2][ 8] = new RooRealVar( "r_peak_double26", "r_peak_double26", 8.755/0.273 );
    }
  }

  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  // READ PDF (swapped miss-PID)
  TFile file_swap( Form("%s/Mbc_peak_swap2_s00.root",pdf_dir) ); // RD
  ...
  if( Nbin_afb == 14 ){
    ...
    if( fl_xsid==1 ){ // Kll
      r_peak_swap[ 0][ 0] = new RooRealVar( "r_peak_swap0", "r_peak_swap0", 0 );
      r_peak_swap[ 0][ 1] = new RooRealVar( "r_peak_swap1", "r_peak_swap1", 0 );
      r_peak_swap[ 0][ 2] = new RooRealVar( "r_peak_swap2", "r_peak_swap2", 0 );
      r_peak_swap[ 0][ 3] = new RooRealVar( "r_peak_swap3", "r_peak_swap3", 0 );
      r_peak_swap[ 0][ 4] = new RooRealVar( "r_peak_swap4", "r_peak_swap4", 0 );
      r_peak_swap[ 0][ 5] = new RooRealVar( "r_peak_swap5", "r_peak_swap5", 0 );
      ...
      r_peak_swap[ 1][ 0] = new RooRealVar( "r_peak_swap9", "r_peak_swap9", 0 );
      r_peak_swap[ 1][ 1] = new RooRealVar( "r_peak_swap10", "r_peak_swap10", 0 );
      r_peak_swap[ 1][ 2] = new RooRealVar( "r_peak_swap11", "r_peak_swap11", 0 );
      r_peak_swap[ 1][ 3] = new RooRealVar( "r_peak_swap12", "r_peak_swap12", 0 );
      r_peak_swap[ 1][ 4] = new RooRealVar( "r_peak_swap13", "r_peak_swap13", 0 );
      r_peak_swap[ 1][ 5] = new RooRealVar( "r_peak_swap14", "r_peak_swap14", 0 );
      r_peak_swap[ 1][ 6] = new RooRealVar( "r_peak_swap15", "r_peak_swap15", 0 );
      r_peak_swap[ 1][ 7] = new RooRealVar( "r_peak_swap16", "r_peak_swap16", 0 );
      r_peak_swap[ 1][ 8] = new RooRealVar( "r_peak_swap17", "r_peak_swap17", 0 );
      r_peak_swap[ 2][ 0] = new RooRealVar( "r_peak_swap18", "r_peak_swap18", 0 );
      r_peak_swap[ 2][ 1] = new RooRealVar( "r_peak_swap19", "r_peak_swap19", 0 );
      r_peak_swap[ 2][ 2] = new RooRealVar( "r_peak_swap20", "r_peak_swap20", 0 );
      r_peak_swap[ 2][ 3] = new RooRealVar( "r_peak_swap21", "r_peak_swap21", 0 );
      r_peak_swap[ 2][ 4] = new RooRealVar( "r_peak_swap22", "r_peak_swap22", 0 );
      r_peak_swap[ 2][ 5] = new RooRealVar( "r_peak_swap23", "r_peak_swap23", 0 );
      r_peak_swap[ 2][ 6] = new RooRealVar( "r_peak_swap24", "r_peak_swap24", 0 );
      r_peak_swap[ 2][ 7] = new RooRealVar( "r_peak_swap25", "r_peak_swap25", 0 );
      r_peak_swap[ 2][ 8] = new RooRealVar( "r_peak_swap26", "r_peak_swap26", 0 );
    }else if( fl_xsid==2 ){ // K*ll
      r_peak_swap[ 0][ 0] = new RooRealVar( "r_peak_swap0", "r_peak_swap0", 0.003971 );
      r_peak_swap[ 0][ 1] = new RooRealVar( "r_peak_swap1", "r_peak_swap1", 0.001831 );
      r_peak_swap[ 0][ 2] = new RooRealVar( "r_peak_swap2", "r_peak_swap2", 0.01734 );
      r_peak_swap[ 0][ 3] = new RooRealVar( "r_peak_swap3", "r_peak_swap3", 0.007692 );
      r_peak_swap[ 0][ 4] = new RooRealVar( "r_peak_swap4", "r_peak_swap4", 0.001227 );
      r_peak_swap[ 0][ 5] = new RooRealVar( "r_peak_swap5", "r_peak_swap5", 0.0003155 );
      r_peak_swap[ 0][ 6] = new RooRealVar( "r_peak_swap6", "r_peak_swap6", 0 );
      r_peak_swap[ 0][ 7] = new RooRealVar( "r_peak_swap7", "r_peak_swap7", 0 );
      r_peak_swap[ 0][ 8] = new RooRealVar( "r_peak_swap8", "r_peak_swap8", 0.03238 );
      r_peak_swap[ 1][ 0] = new RooRealVar( "r_peak_swap9", "r_peak_swap9", 0.05714 );
      r_peak_swap[ 1][ 1] = new RooRealVar( "r_peak_swap10", "r_peak_swap10", 0.09774 );
      r_peak_swap[ 1][ 2] = new RooRealVar( "r_peak_swap11", "r_peak_swap11", 1.121 );
      r_peak_swap[ 1][ 3] = new RooRealVar( "r_peak_swap12", "r_peak_swap12", 0.4362 );
      r_peak_swap[ 1][ 4] = new RooRealVar( "r_peak_swap13", "r_peak_swap13", 0.03918 );
      r_peak_swap[ 1][ 5] = new RooRealVar( "r_peak_swap14", "r_peak_swap14", 0.04622 );
      r_peak_swap[ 1][ 6] = new RooRealVar( "r_peak_swap15", "r_peak_swap15", 0 );
      r_peak_swap[ 1][ 7] = new RooRealVar( "r_peak_swap16", "r_peak_swap16", 0 );
      r_peak_swap[ 1][ 8] = new RooRealVar( "r_peak_swap17", "r_peak_swap17", 1.797 );
      r_peak_swap[ 2][ 0] = new RooRealVar( "r_peak_swap18", "r_peak_swap18", 0.06112 );
      r_peak_swap[ 2][ 1] = new RooRealVar( "r_peak_swap19", "r_peak_swap19", 0.09957 );
      r_peak_swap[ 2][ 2] = new RooRealVar( "r_peak_swap20", "r_peak_swap20", 1.138 );
      r_peak_swap[ 2][ 3] = new RooRealVar( "r_peak_swap21", "r_peak_swap21", 0.4439 );
      r_peak_swap[ 2][ 4] = new RooRealVar( "r_peak_swap22", "r_peak_swap22", 0.04041 );
      r_peak_swap[ 2][ 5] = new RooRealVar( "r_peak_swap23", "r_peak_swap23", 0.04654 );
      r_peak_swap[ 2][ 6] = new RooRealVar( "r_peak_swap24", "r_peak_swap24", 0 );
      r_peak_swap[ 2][ 7] = new RooRealVar( "r_peak_swap25", "r_peak_swap25", 0 );
      r_peak_swap[ 2][ 8] = new RooRealVar( "r_peak_swap26", "r_peak_swap26", 1.83 );
    }else if( fl_xsid==3 ){ // Xsll
      r_peak_swap[ 0][ 0] = new RooRealVar( "r_peak_swap0", "r_peak_swap0", 0.02175 );
      r_peak_swap[ 0][ 1] = new RooRealVar( "r_peak_swap1", "r_peak_swap1", 0.0121 );
      r_peak_swap[ 0][ 2] = new RooRealVar( "r_peak_swap2", "r_peak_swap2", 0.01465 );
      r_peak_swap[ 0][ 3] = new RooRealVar( "r_peak_swap3", "r_peak_swap3", 0.009636 );
      r_peak_swap[ 0][ 4] = new RooRealVar( "r_peak_swap4", "r_peak_swap4", 0.001599 );
      r_peak_swap[ 0][ 5] = new RooRealVar( "r_peak_swap5", "r_peak_swap5", 0.0002093 );
      r_peak_swap[ 0][ 6] = new RooRealVar( "r_peak_swap6", "r_peak_swap6", 0 );
      r_peak_swap[ 0][ 7] = new RooRealVar( "r_peak_swap7", "r_peak_swap7", 0 );
      r_peak_swap[ 0][ 8] = new RooRealVar( "r_peak_swap8", "r_peak_swap8", 0.05995 );
      r_peak_swap[ 1][ 0] = new RooRealVar( "r_peak_swap9", "r_peak_swap9", 0.3904 );
      r_peak_swap[ 1][ 1] = new RooRealVar( "r_peak_swap10", "r_peak_swap10", 0.3996 );
      r_peak_swap[ 1][ 2] = new RooRealVar( "r_peak_swap11", "r_peak_swap11", 0.6861 );
      r_peak_swap[ 1][ 3] = new RooRealVar( "r_peak_swap12", "r_peak_swap12", 0.5768 );
      r_peak_swap[ 1][ 4] = new RooRealVar( "r_peak_swap13", "r_peak_swap13", 0.05764 );
      r_peak_swap[ 1][ 5] = new RooRealVar( "r_peak_swap14", "r_peak_swap14", 0.02196 );
      r_peak_swap[ 1][ 6] = new RooRealVar( "r_peak_swap15", "r_peak_swap15", 0 );
      r_peak_swap[ 1][ 7] = new RooRealVar( "r_peak_swap16", "r_peak_swap16", 0 );
      r_peak_swap[ 1][ 8] = new RooRealVar( "r_peak_swap17", "r_peak_swap17", 2.132 );
      r_peak_swap[ 2][ 0] = new RooRealVar( "r_peak_swap18", "r_peak_swap18", 0.4121 );
      r_peak_swap[ 2][ 1] = new RooRealVar( "r_peak_swap19", "r_peak_swap19", 0.4117 );
      r_peak_swap[ 2][ 2] = new RooRealVar( "r_peak_swap20", "r_peak_swap20", 0.7007 );
      r_peak_swap[ 2][ 3] = new RooRealVar( "r_peak_swap21", "r_peak_swap21", 0.5865 );
      r_peak_swap[ 2][ 4] = new RooRealVar( "r_peak_swap22", "r_peak_swap22", 0.05924 );
      r_peak_swap[ 2][ 5] = new RooRealVar( "r_peak_swap23", "r_peak_swap23", 0.02217 );
      r_peak_swap[ 2][ 6] = new RooRealVar( "r_peak_swap24", "r_peak_swap24", 0 );
      r_peak_swap[ 2][ 7] = new RooRealVar( "r_peak_swap25", "r_peak_swap25", 0 );
      r_peak_swap[ 2][ 8] = new RooRealVar( "r_peak_swap26", "r_peak_swap26", 2.192 );
    }
  }

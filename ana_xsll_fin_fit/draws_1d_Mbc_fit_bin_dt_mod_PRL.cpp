...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  if( Nbin_afb == 14 ){
    ...
    //*/
    /* syst xs-spin @20151224
    cf_slope[ 0][ 0] = new RooRealVar( "cf_0_0", "cf_0_0",     1.2893+0.070 );
    cf_slope[ 0][ 1] = new RooRealVar( "cf_0_1", "cf_0_1",    1.13893+0.015 );
    cf_slope[ 0][ 2] = new RooRealVar( "cf_0_2", "cf_0_2",    1.06319+0.073 );
    cf_slope[ 0][ 3] = new RooRealVar( "cf_0_3", "cf_0_3",    1.12141+0.089 );
    cf_slope[ 1][ 0] = new RooRealVar( "cf_1_0", "cf_1_0",    2.08178+0.077 );
    cf_slope[ 1][ 1] = new RooRealVar( "cf_1_1", "cf_1_1",    1.37547+0.045 );
    cf_slope[ 1][ 2] = new RooRealVar( "cf_1_2", "cf_1_2",    1.03293+0.026 );
    cf_slope[ 1][ 3] = new RooRealVar( "cf_1_3", "cf_1_3",    1.08232+0.030 );
    */
 }
  ...
  TFile file_double("pdf/Mbc_peak_double2_s00.root"); // RD
  ...
  TFile file_swap("pdf/Mbc_peak_swap2_s00.root"); // RD

...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  if( !(argc==4 || argc==5) ) std::cerr << "wrong input" << std::endl
					<< " Usage : ./draws_1d_fmiss (char*)stream (char*)setname (int)fl_axis [(int)fl_appRun]" << std::endl
  ...
  std::cout << std::endl
	    << " ************************ make hist *************************************" << std::endl;
  hist[0] = new TH1D( "fmiss_sig_lep1", "fmiss_sig_lep1", xbin[fl_axis],offset[fl_axis]+xmin[fl_axis],offset[fl_axis]+xmax[fl_axis] );
  hist[1] = new TH1D( "fmiss_qq_lep1",  "fmiss_qq_lep1",  xbin[fl_axis],offset[fl_axis]+xmin[fl_axis],offset[fl_axis]+xmax[fl_axis] );
  hist[2] = new TH1D( "fmiss_bb_lep1",  "fmiss_bb_lep1",  xbin[fl_axis],offset[fl_axis]+xmin[fl_axis],offset[fl_axis]+xmax[fl_axis] );
  hist[3] = new TH1D( "fmiss_sig_lep0", "fmiss_sig_lep0", xbin[fl_axis],offset[fl_axis]+xmin[fl_axis],offset[fl_axis]+xmax[fl_axis] );
  hist[4] = new TH1D( "fmiss_qq_lep0",  "fmiss_qq_lep0",  xbin[fl_axis],offset[fl_axis]+xmin[fl_axis],offset[fl_axis]+xmax[fl_axis] );
  hist[5] = new TH1D( "fmiss_bb_lep0",  "fmiss_bb_lep0",  xbin[fl_axis],offset[fl_axis]+xmin[fl_axis],offset[fl_axis]+xmax[fl_axis] );
  ...
  c1->Update();
  if( flag_save ){
    c1->Print(     Form("pic/fmiss_%s_s0%s_set%s.eps",  fname[fl_axis], stream,setname) );
    TFile outfile( Form("pic/fmiss_%s_s0%s_set%s.root", fname[fl_axis], stream,setname), "RECREATE" );
    c1->Write();

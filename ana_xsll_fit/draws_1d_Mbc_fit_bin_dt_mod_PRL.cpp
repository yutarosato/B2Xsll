...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  if( Nbin_afb == 14 ){
    ...
    */
    ...
    //*/
    /* ff6 @20150115
    cf_slope[ 0][ 0] = new RooRealVar( "cf_0_0", "cf_0_0",    1.29351 );
    cf_slope[ 0][ 1] = new RooRealVar( "cf_0_1", "cf_0_1",    1.12896 );
    cf_slope[ 0][ 2] = new RooRealVar( "cf_0_2", "cf_0_2",    1.06163 );
    cf_slope[ 0][ 3] = new RooRealVar( "cf_0_3", "cf_0_3",    1.14671 );
    cf_slope[ 1][ 0] = new RooRealVar( "cf_1_0", "cf_1_0",    2.07777 );
    cf_slope[ 1][ 1] = new RooRealVar( "cf_1_1", "cf_1_1",     1.3558 );
    cf_slope[ 1][ 2] = new RooRealVar( "cf_1_2", "cf_1_2",    1.03037 );
    cf_slope[ 1][ 3] = new RooRealVar( "cf_1_3", "cf_1_3",    1.09748 );
    */
    //*/
  }

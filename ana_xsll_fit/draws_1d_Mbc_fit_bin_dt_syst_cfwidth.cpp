...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  for( Int_t j=0; j<Nbin_afb/2; j++ ) cf_offset[2][j] = new RooRealVar( Form("cf_2_%d",j), Form("cf_2_%d",j), 0.0 ); // dummy
  {
    ...
    cf_offset[ 0][ 0] = new RooRealVar( "cfo_0_0", "cfo_0_0",    0.007238  *tmp_rnd );
    cf_offset[ 0][ 1] = new RooRealVar( "cfo_0_1", "cfo_0_1",    0.001633  *tmp_rnd );
    cf_offset[ 0][ 2] = new RooRealVar( "cfo_0_2", "cfo_0_2",    0.0063933 *tmp_rnd );
    cf_offset[ 0][ 3] = new RooRealVar( "cfo_0_3", "cfo_0_3",    0.003193  *tmp_rnd );
    cf_offset[ 1][ 0] = new RooRealVar( "cfo_1_0", "cfo_1_0",    0.0065723 *tmp_rnd );
    cf_offset[ 1][ 1] = new RooRealVar( "cfo_1_1", "cfo_1_1",    0.007965  *tmp_rnd );
    cf_offset[ 1][ 2] = new RooRealVar( "cfo_1_2", "cfo_1_2",    0.00012404*tmp_rnd );
    cf_offset[ 1][ 3] = new RooRealVar( "cfo_1_3", "cfo_1_3",    0.0012754 *tmp_rnd );
  }
  for( Int_t i=0; i<Nroohist; i++ ){

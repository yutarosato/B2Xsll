...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  if( !flag_roof ){
	...
	Int_t k = n + 2*m;
	c1[m][n]->Update();
	if( fl_q2bin==0 ) c1[m][n]->Print( Form("pic/%s_fit_bin_dt_kll_func%d_c1_%d.eps",  axis, sel_fun, k+1) );
      }
    }
  ...
  TFile file_scf("pdf_data_kll/Mbc_self_cf2_setA-U.root");
  ...
  for( Int_t i=0; i<Nroohist; i++ ){
    ...
    for( Int_t j=0; j<Nbin_afb; j++ ){
      Double_t tmp_nbkg = 10;
      nbkg    [i][j] = new RooRealVar ( Form("N_{bkg}%d_%d",      i,j), Form("N_{bkg}%d_%d",      i,j), tmp_nbkg, tmp_nbkg-20, tmp_nbkg+90 );
      nbkg_sim[i][j] = new RooRealVar ( Form("N_{bkg}^{sim}%d_%d",i,j), Form("N_{bkg}^{sim}%d_%d",i,j), tmp_nbkg, tmp_nbkg-20, tmp_nbkg+70 );
    }
  }
  ...
  TFile file_cc("pdf_data_kll/Mbc_peak_cc2_s00.root"); // CC-MC
  ...
  r_peak_cc[ 0][ 1] = new RooRealVar( "r_peak_cc1", "r_peak_cc1",   scale_cc[0]*0 );
  r_peak_cc[ 0][ 2] = new RooRealVar( "r_peak_cc2", "r_peak_cc2",   scale_cc[0]*0 );
  r_peak_cc[ 0][ 3] = new RooRealVar( "r_peak_cc3", "r_peak_cc3",   scale_cc[0]*0 );
  r_peak_cc[ 0][ 4] = new RooRealVar( "r_peak_cc4", "r_peak_cc4",   scale_cc[0]*0.03 );
  r_peak_cc[ 0][ 5] = new RooRealVar( "r_peak_cc5", "r_peak_cc5",   scale_cc[0]*0.02 );
  ...
  r_peak_cc[ 0][ 8] = new RooRealVar( "r_peak_cc8", "r_peak_cc8",   scale_cc[0]*0.05 );
  r_peak_cc[ 1][ 0] = new RooRealVar( "r_peak_cc9", "r_peak_cc9",   scale_cc[1]*0 );
  r_peak_cc[ 1][ 1] = new RooRealVar( "r_peak_cc10", "r_peak_cc10", scale_cc[1]*0 );
  r_peak_cc[ 1][ 2] = new RooRealVar( "r_peak_cc11", "r_peak_cc11", scale_cc[1]*0 );
  r_peak_cc[ 1][ 3] = new RooRealVar( "r_peak_cc12", "r_peak_cc12", scale_cc[1]*0.01 );
  r_peak_cc[ 1][ 4] = new RooRealVar( "r_peak_cc13", "r_peak_cc13", scale_cc[1]*0.01 );
  r_peak_cc[ 1][ 5] = new RooRealVar( "r_peak_cc14", "r_peak_cc14", scale_cc[1]*0 );
  r_peak_cc[ 1][ 6] = new RooRealVar( "r_peak_cc15", "r_peak_cc15", scale_cc[1]*0.01 );
  r_peak_cc[ 1][ 7] = new RooRealVar( "r_peak_cc16", "r_peak_cc16", scale_cc[1]*0.01 );
  r_peak_cc[ 1][ 8] = new RooRealVar( "r_peak_cc17", "r_peak_cc17", scale_cc[1]*0.04 );
  r_peak_cc[ 2][ 0] = new RooRealVar( "r_peak_cc18", "r_peak_cc18", scale_cc[2]*0 );
  r_peak_cc[ 2][ 1] = new RooRealVar( "r_peak_cc19", "r_peak_cc19", scale_cc[2]*0 );
  r_peak_cc[ 2][ 2] = new RooRealVar( "r_peak_cc20", "r_peak_cc20", scale_cc[2]*0 );
  r_peak_cc[ 2][ 3] = new RooRealVar( "r_peak_cc21", "r_peak_cc21", scale_cc[2]*0.01 );
  r_peak_cc[ 2][ 4] = new RooRealVar( "r_peak_cc22", "r_peak_cc22", scale_cc[2]*0.04 );
  r_peak_cc[ 2][ 5] = new RooRealVar( "r_peak_cc23", "r_peak_cc23", scale_cc[2]*0.02 );
  r_peak_cc[ 2][ 6] = new RooRealVar( "r_peak_cc24", "r_peak_cc24", scale_cc[2]*0.01 );
  r_peak_cc[ 2][ 7] = new RooRealVar( "r_peak_cc25", "r_peak_cc25", scale_cc[2]*0.01 );
  r_peak_cc[ 2][ 8] = new RooRealVar( "r_peak_cc26", "r_peak_cc26", scale_cc[2]*0.09 );
  ...
  TFile file_double("pdf_data_kll/Mbc_peak_double2_s00.root"); // RD
  ...
  TFile file_swap("pdf_data_kll/Mbc_peak_swap2_s00.root"); // RD
  ...
  */
  ...
  if( flag_save ){
    TFile outfile( Form("pic/%s_fit_bin_dt_kll_func%d_%dq2.root",  axis, sel_fun, fl_q2bin), "RECREATE" );
    for( Int_t i=0; i<Nroohist; i++ ){
      for( Int_t j=0; j<2; j++ ){ // [hist, fitted hist]
	Int_t k = j + 2*i;
	if( fl_q2bin==0 ) c1[i][j]->Print( Form("pic/%s_fit_bin_dt_kll_func%d_c1_%d.eps",  axis, sel_fun, k+1) );
	if( fl_q2bin==0 ) c1[i][j]->Write();
      }
    }

    c2->Print( Form("pic/%s_fit_bin_dt_kll_func%d_%dq2_c2.eps",  axis, sel_fun, fl_q2bin) );
    c2->Write();

    c3->Print( Form("pic/%s_fit_bin_dt_kll_func%d_%dq2_c3.eps",  axis, sel_fun, fl_q2bin) );
    c3->Write();
    //c4->Print( Form("pic/%s_fit_bin_dt_kll_func%d_%dq2_c4.eps",  axis, sel_fun, fl_q2bin) );
    //c4->Write();

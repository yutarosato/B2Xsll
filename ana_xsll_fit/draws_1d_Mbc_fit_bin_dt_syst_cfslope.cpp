...
const Double_t cf_slope_syst[22][2][4] = {
  { {1.2893,  1.13893, 1.06319, 1.12141}, {2.08178, 1.37547, 1.03293, 1.08232} }, // axis 0 (default)
  { {1.29557, 1.12597, 1.04887, 1.10427}, {2.09443, 1.37543, 1.02133, 1.06519} }, // axis 1 (fm200)
  { {1.28905, 1.14936, 1.06174, 1.12039}, {2.06103, 1.38851, 1.03177, 1.08111} }, // axis 2 (fm480)
  { {1.28647, 1.14403, 1.05881, 1.12205}, {2.0615,  1.37818, 1.03117, 1.08293} }, // axis 3 (mb465)
  { {1.28258, 1.1456,  1.05357, 1.12249}, {2.07191, 1.37833, 1.02896, 1.08439} }, // axis 4 (mb495)
  { {1.29178, 1.1456,  1.0554,  1.12913}, {2.08049, 1.37935, 1.03003, 1.10034} }, // axis 5 (tr10)
  { {1.28444, 1.15065, 1.05964, 1.11048}, {2.0683,  1.38321, 1.02711, 1.07192} }, // axis 6 (tr12)
  { {1.2865,  1.14078, 1.06505, 1.12146}, {2.07514, 1.37761, 1.03334, 1.08224} }, // axis 7 (hadro)
  { {1.28844, 1.14226, 1.06671, 1.12718}, {2.07831, 1.38005, 1.03576, 1.08666} }, // axis 8 (kll_p)
  { {1.28731, 1.13509, 1.05972, 1.11698}, {2.07916, 1.37203, 1.03001, 1.07813} }, // axis 9 (kll_m)
  { {1.28726, 1.13534, 1.05925, 1.11525}, {2.0783,  1.37262, 1.02946, 1.07657} }, // axis10 (kstrll_p)
  { {1.28848, 1.14261, 1.06795, 1.13028}, {2.07902, 1.37999, 1.03696, 1.0894 } }, // axis11 (kstrll_m)
  { {1.28813, 1.13763, 1.06382, 1.12579}, {2.08072, 1.37419, 1.03373, 1.08578} }, // axis12 (xsll_p)
  { {1.28845, 1.13966, 1.06231, 1.11848}, {2.0771,  1.37821, 1.03173, 1.07909} }, // axis13 (xsll_m)
  { {1.34366, 1.13655, 1.06245, 1.11408}, {2.18857, 1.35460, 1.03257, 1.08032} }, // flip
  { {1.3861,  1.1302,  1.04294, 1.11865}, {2.20149, 1.38797, 1.1387,  1.07568} }, // xsspin
  { {1.380,   1.142,   1.042,   1.116},   {2.183,   1.399,   1.013,   1.074  } }, // xsspin(fr-50)
  { {1.385,   1.133,   1.043,   1.118},   {2.198,   1.390,   1.014,   1.075  } }, // xsspin(fr-10)
  { {1.387,   1.128,   1.043,   1.119},   {2.205,   1.386,   1.014,   1.076  } }, // xsspin(fr 10)
  { {1.391,   1.118,   1.044,   1.121},   {2.217,   1.376,   1.015,   1.078  } }, // xsspin(fr 50)
  { {1.29081, 1.15991, 1.06676, 1.11713}, {2.0842,  1.38507, 1.02435, 1.07847} }, // lambdaone362
  { {1.3004,  1.16537, 1.06063, 1.11802}, {2.05593, 1.37993, 1.03408, 1.08199} }, // lambdaone429
};
...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  if( !(argc==4 || argc==5) ) std::cerr << "wrong input" << std::endl
					<< " Usage : ./draws_1d_Mbc_fit (int)sel_fun (int)fl_q2bin (int)fl_axis [(int)fl_appRun]"    << std::endl
  ...
  if( !flag_roof ){
	...
	Int_t k = n + 2*m;
	c1[m][n]->Update();
	if( fl_q2bin==0 && fl_axis ) c1[m][n]->Print( Form("pic/%s_fit_bin_dt_func%d_c1_%d.eps",  axis, sel_fun, k+1) );
      }
    }
  ...
  if( Nbin_afb == 14 ){
    ...
    */
    // systematic study
    cf_slope[ 0][ 0] = new RooRealVar( "cf_0_0", "cf_0_0",    cf_slope_syst[fl_axis][0][0] );
    cf_slope[ 0][ 1] = new RooRealVar( "cf_0_1", "cf_0_1",    cf_slope_syst[fl_axis][0][1] );
    cf_slope[ 0][ 2] = new RooRealVar( "cf_0_2", "cf_0_2",    cf_slope_syst[fl_axis][0][2] );
    cf_slope[ 0][ 3] = new RooRealVar( "cf_0_3", "cf_0_3",    cf_slope_syst[fl_axis][0][3] );
    cf_slope[ 1][ 0] = new RooRealVar( "cf_1_0", "cf_1_0",    cf_slope_syst[fl_axis][1][0] );
    cf_slope[ 1][ 1] = new RooRealVar( "cf_1_1", "cf_1_1",    cf_slope_syst[fl_axis][1][1] );
    cf_slope[ 1][ 2] = new RooRealVar( "cf_1_2", "cf_1_2",    cf_slope_syst[fl_axis][1][2] );
    cf_slope[ 1][ 3] = new RooRealVar( "cf_1_3", "cf_1_3",    cf_slope_syst[fl_axis][1][3] );
  }
  ...
  */
  ...
  if( flag_save ){
    TFile outfile( Form("pic/%s_fit_bin_dt_func%d_axis%d_%dq2.root",  axis, sel_fun, fl_axis, fl_q2bin), "RECREATE" );
    for( Int_t i=0; i<Nroohist; i++ ){
      for( Int_t j=0; j<2; j++ ){ // [hist, fitted hist]
	Int_t k = j + 2*i;
	if( fl_q2bin==0 && fl_axis ) c1[i][j]->Print( Form("pic/%s_fit_bin_dt_func%d_c1_%d.eps",  axis, sel_fun, k+1) );
	if( fl_q2bin==0 && fl_axis ) c1[i][j]->Write();
      }
    }

    c2->Print( Form("pic/%s_fit_bin_dt_func%d_axis%d_%dq2_c2.eps",  axis, sel_fun, fl_axis, fl_q2bin) );
    c2->Write();

    c3->Print( Form("pic/%s_fit_bin_dt_func%d_axis%d_%dq2_c3.eps",  axis, sel_fun, fl_axis, fl_q2bin) );
    c3->Write();
    //c4->Print( Form("pic/%s_fit_bin_dt_func%d_axis%d_%dq2_c4.eps",  axis, sel_fun, fl_axis, fl_q2bin) );
    //c4->Write();

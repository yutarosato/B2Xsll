...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  for( Int_t i=0; i<Nroohist; i++ ){
    ...
    for( Int_t j=0; j<Nbin_afb/2; j++ ){
      ...
      if(      i==0 && j==1 ) AFB_meas[i][j] = new RooFormulaVar( Form("A_{FB}^{meas.}_%d_%d",i,j),  "1.01868/@0*@1", RooArgSet(*cf_slope[i][j], *AFB_true[j]) ); // modified @ 2013092413
  ...
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  // READ PDF (single miss-PID with neutrino) for syst study
  TFile file_single_nu("pdf_single_nu/Mbc_peak_single_nu2_s00-5.root");
  if( file_single_nu.IsZombie() ) std::cerr << "[ABORT] can not find input-file : " << file_single_nu.GetName() << std::endl, abort();
  
  TH1D*** hist_single_nu = new TH1D**[Nroohist];
  for( Int_t i=0; i<Nroohist; i++ ){
    hist_single_nu[i] = new TH1D*[Nbin_afb+1];
    for( Int_t j=0; j<Nbin_afb+1; j++ ){
      Int_t k = j + i*(Nbin_afb+1);
      hist_single_nu[i][j] = (TH1D*)file_single_nu.Get( Form("hist%d",k) );
      if( hist_single_nu[i][j] == NULL ) std::cerr << "[ABORT] can not find histgram (single_nu)" << k << std::endl, abort();
    }
  }

  RooDataHist*** peak_single_nu         = new RooDataHist**[Nroohist];
  RooDataHist*** peak_single_nu_sim     = new RooDataHist**[Nroohist];
  RooHistPdf***  pdf_peak_single_nu     = new RooHistPdf** [Nroohist];
  RooHistPdf***  pdf_peak_single_nu_sim = new RooHistPdf** [Nroohist];
  
  for( Int_t i=0; i<Nroohist; i++ ){
    peak_single_nu        [i] = new RooDataHist*[Nbin_afb+1];
    peak_single_nu_sim    [i] = new RooDataHist*[Nbin_afb+1];
    pdf_peak_single_nu    [i] = new RooHistPdf* [Nbin_afb+1];
    pdf_peak_single_nu_sim[i] = new RooHistPdf* [Nbin_afb+1];
    for( Int_t j=0; j<Nbin_afb+1; j++ ){
      Int_t k = j + i*(Nbin_afb+1);
      peak_single_nu        [i][j] = new RooDataHist( Form("peak_single_nu%d",           k), Form("peak_single_nu%d",       k), *obs[i],  hist_single_nu     [i][j] );
      peak_single_nu_sim    [i][j] = new RooDataHist( Form("peak_single_nu^{sim}%d",     k), Form("peak_single_nu^{sim}%d", k), *obs_sim, hist_single_nu     [i][j] );
      pdf_peak_single_nu    [i][j] = new RooHistPdf ( Form("pdf_peak_single_nu%d",       k), Form("peak_single_nu%d",       k), *obs[i],  *peak_single_nu    [i][j] );
      pdf_peak_single_nu_sim[i][j] = new RooHistPdf ( Form("pdf_peak_single_nu^{sim}%d", k), Form("peak_single_nu^{sim}%d", k), *obs_sim, *peak_single_nu_sim[i][j] );
    }
  }

  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  // SETTING of COEFFICIENT (single miss-PID)
  RooRealVar*** r_peak_single_nu = new RooRealVar**[Nroohist];
  for( Int_t i=0; i<Nroohist; i++ ) r_peak_single_nu[i] = new RooRealVar*[Nbin_afb+1];
  r_peak_single_nu[ 0][ 0] = new RooRealVar( "r_peak_single_nu0", "r_peak_single_nu0", 0 );
  r_peak_single_nu[ 0][ 1] = new RooRealVar( "r_peak_single_nu1", "r_peak_single_nu1", 0.3333 );
  r_peak_single_nu[ 0][ 2] = new RooRealVar( "r_peak_single_nu2", "r_peak_single_nu2", 0.1667 );
  r_peak_single_nu[ 0][ 3] = new RooRealVar( "r_peak_single_nu3", "r_peak_single_nu3", 0 );
  r_peak_single_nu[ 0][ 4] = new RooRealVar( "r_peak_single_nu4", "r_peak_single_nu4", 0.3333 );
  r_peak_single_nu[ 0][ 5] = new RooRealVar( "r_peak_single_nu5", "r_peak_single_nu5", 0 );
  r_peak_single_nu[ 0][ 6] = new RooRealVar( "r_peak_single_nu6", "r_peak_single_nu6", 0.6667 );
  r_peak_single_nu[ 0][ 7] = new RooRealVar( "r_peak_single_nu7", "r_peak_single_nu7", 0 );
  r_peak_single_nu[ 0][ 8] = new RooRealVar( "r_peak_single_nu8", "r_peak_single_nu8", 1.5 );
  r_peak_single_nu[ 1][ 0] = new RooRealVar( "r_peak_single_nu9", "r_peak_single_nu9", 0.1667 );
  r_peak_single_nu[ 1][ 1] = new RooRealVar( "r_peak_single_nu10", "r_peak_single_nu10", 0 );
  r_peak_single_nu[ 1][ 2] = new RooRealVar( "r_peak_single_nu11", "r_peak_single_nu11", 2 );
  r_peak_single_nu[ 1][ 3] = new RooRealVar( "r_peak_single_nu12", "r_peak_single_nu12", 0 );
  r_peak_single_nu[ 1][ 4] = new RooRealVar( "r_peak_single_nu13", "r_peak_single_nu13", 1.5 );
  r_peak_single_nu[ 1][ 5] = new RooRealVar( "r_peak_single_nu14", "r_peak_single_nu14", 0 );
  r_peak_single_nu[ 1][ 6] = new RooRealVar( "r_peak_single_nu15", "r_peak_single_nu15", 1.5 );
  r_peak_single_nu[ 1][ 7] = new RooRealVar( "r_peak_single_nu16", "r_peak_single_nu16", 0.5 );
  r_peak_single_nu[ 1][ 8] = new RooRealVar( "r_peak_single_nu17", "r_peak_single_nu17", 5.667 );
  r_peak_single_nu[ 2][ 0] = new RooRealVar( "r_peak_single_nu18", "r_peak_single_nu18", 0.1667 );
  r_peak_single_nu[ 2][ 1] = new RooRealVar( "r_peak_single_nu19", "r_peak_single_nu19", 0.3333 );
  r_peak_single_nu[ 2][ 2] = new RooRealVar( "r_peak_single_nu20", "r_peak_single_nu20", 2.167 );
  r_peak_single_nu[ 2][ 3] = new RooRealVar( "r_peak_single_nu21", "r_peak_single_nu21", 0 );
  r_peak_single_nu[ 2][ 4] = new RooRealVar( "r_peak_single_nu22", "r_peak_single_nu22", 1.833 );
  r_peak_single_nu[ 2][ 5] = new RooRealVar( "r_peak_single_nu23", "r_peak_single_nu23", 0 );
  r_peak_single_nu[ 2][ 6] = new RooRealVar( "r_peak_single_nu24", "r_peak_single_nu24", 2.167 );
  r_peak_single_nu[ 2][ 7] = new RooRealVar( "r_peak_single_nu25", "r_peak_single_nu25", 0.5 );
  r_peak_single_nu[ 2][ 8] = new RooRealVar( "r_peak_single_nu26", "r_peak_single_nu26", 7.167 );
  ...
  for( Int_t i=0; i<Nroohist; i++ ){
    ...
    for( Int_t j=0; j<Nbin_afb; j++ ){
      Int_t k = j + i*Nbin_afb;
      if( fl_q2bin!=3 ){
	if( ( i==0 && (j==1 || j==2 || j==4 || j==6) ) || ( i==1 && (j==0 || j==2 || j==4 || j==6 || j==7 ) ) || ( i==2 && (j==0 || j==1 || j==2 || j==4 || j==6 || j==7 ) ) ){
	  pdf    [i][j] = new RooAddPdf( Form("pdf%d",    k), Form("pdf%d",    k), RooArgList(*gauss    [i], *modargus    [i][j], *pdf_scf_tt    [i][j], *pdf_scf_tf    [i][j], *pdf_peak_cc    [i][j], *pdf_peak_double    [i][j], *pdf_peak_swap    [i][j], *pdf_peak_single_nu    [i][j]), RooArgList(*nsig     [i][j], *nbkg    [i][j], *nsig_tt    [i][j], *nsig_tf    [i][j], *r_peak_cc[i][j], *r_peak_double[i][j], *r_peak_swap[i][j], *r_peak_single_nu[i][j] ) ); // signal + scf + peak
	  pdf_sim[i][j] = new RooAddPdf( Form("pdf_sim%d",k), Form("pdf_sim%d",k), RooArgList(*gauss_sim[i], *modargus_sim[i][j], *pdf_scf_tt_sim[i][j], *pdf_scf_tf_sim[i][j], *pdf_peak_cc_sim[i][j], *pdf_peak_double_sim[i][j], *pdf_peak_swap_sim[i][j], *pdf_peak_single_nu_sim[i][j]), RooArgList(*nsig_sim [i][j], *nbkg_sim[i][j], *nsig_tt_sim[i][j], *nsig_tf_sim[i][j], *r_peak_cc[i][j], *r_peak_double[i][j], *r_peak_swap[i][j], *r_peak_single_nu[i][j] ) ); // signal + scf + peak
	}else{
	...
	if( ( i==0 && (j==1 || j==2 || j==4 || j==6) ) || ( i==1 && (j==0 || j==2 || j==4 || j==6 || j==7 ) ) || ( i==2 && (j==0 || j==1 || j==2 || j==4 || j==6 || j==7 ) ) ){
	  pdf    [i][j] = new RooAddPdf( Form("pdf%d",    k), Form("pdf%d",    k), RooArgList(*gauss    [i], *modargus    [i][j], *pdf_scf_tt    [i][j], *pdf_scf_tf    [i][j], *pdf_peak_double    [i][j],  *pdf_peak_single_nu    [i][j]), RooArgList(*nsig     [i][j], *nbkg    [i][j], *nsig_tt    [i][j], *nsig_tf    [i][j], *r_peak_double[i][j], *r_peak_single_nu[i][j]) ); // signal + scf + peak [for 6th q2 bin]a
	  pdf_sim[i][j] = new RooAddPdf( Form("pdf_sim%d",k), Form("pdf_sim%d",k), RooArgList(*gauss_sim[i], *modargus_sim[i][j], *pdf_scf_tt_sim[i][j], *pdf_scf_tf_sim[i][j], *pdf_peak_double_sim[i][j], *pdf_peak_single_nu_sim[i][j]), RooArgList(*nsig_sim [i][j], *nbkg_sim[i][j], *nsig_tt_sim[i][j], *nsig_tf_sim[i][j], *r_peak_double[i][j], *r_peak_single_nu[i][j]) ); // signal + scf + peak [for 6th q2 bin]
	}else{

...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  scale_swap[0] += 0.28*(Double_t)fl_syst*scale_swap[0];
  scale_swap[1] += 0.04*(Double_t)fl_syst*scale_swap[1];
  scale_swap[2] += 0.28*(Double_t)fl_syst*scale_swap[2];
  ...
  */
  ...
  if( flag_save ){
    TFile outfile( Form("pic/%s_fit_bin_dt_func%d_%dq2_swap_cnt%d.root",  axis, sel_fun, fl_q2bin, fl_syst), "RECREATE" );
    for( Int_t i=0; i<Nroohist; i++ ){
    ...
    c2->Print( Form("pic/%s_fit_bin_dt_func%d_%dq2_c2_swap_cnt%d.eps",  axis, sel_fun, fl_q2bin, fl_syst) );
    c2->Write();

    c3->Print( Form("pic/%s_fit_bin_dt_func%d_%dq2_c3_swap_cnt%d.eps",  axis, sel_fun, fl_q2bin, fl_syst) );
    c3->Write();

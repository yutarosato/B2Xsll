...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  scale_double[0] += 0.55*(Double_t)fl_syst*scale_double[0];
  scale_double[1] += 0.07*(Double_t)fl_syst*scale_double[1];
  scale_double[2] += 0.55*(Double_t)fl_syst*scale_double[2];
  ...
  if( Nbin_afb == 14 ){
    ...
    */
    // RD
    ///*
    r_peak_double[ 0][ 0] = new RooRealVar( "r_peak_double0", "r_peak_double0", 0.02861/0.273*scale_double[0] );
    r_peak_double[ 0][ 1] = new RooRealVar( "r_peak_double1", "r_peak_double1", 0.03078/0.273*scale_double[0] );
    r_peak_double[ 0][ 2] = new RooRealVar( "r_peak_double2", "r_peak_double2", 0.02203/0.273*scale_double[0] );
    r_peak_double[ 0][ 3] = new RooRealVar( "r_peak_double3", "r_peak_double3", 0.01914/0.273*scale_double[0] );
    r_peak_double[ 0][ 4] = new RooRealVar( "r_peak_double4", "r_peak_double4", 0.02482/0.273*scale_double[0] );
    r_peak_double[ 0][ 5] = new RooRealVar( "r_peak_double5", "r_peak_double5", 0.01664/0.273*scale_double[0] );
    r_peak_double[ 0][ 6] = new RooRealVar( "r_peak_double6", "r_peak_double6", 0.01268/0.273*scale_double[0] );
    r_peak_double[ 0][ 7] = new RooRealVar( "r_peak_double7", "r_peak_double7", 0.007482/0.273*scale_double[0] );
    r_peak_double[ 0][ 8] = new RooRealVar( "r_peak_double8", "r_peak_double8", 0.01157/0.273*scale_double[0] );
    r_peak_double[ 0][ 9] = new RooRealVar( "r_peak_double9", "r_peak_double9", 0.006718/0.273*scale_double[0] );
    r_peak_double[ 0][10] = new RooRealVar( "r_peak_double10", "r_peak_double10", 0.01527/0.273*scale_double[0] );
    r_peak_double[ 0][11] = new RooRealVar( "r_peak_double11", "r_peak_double11", 0.009497/0.273*scale_double[0] );
    r_peak_double[ 0][12] = new RooRealVar( "r_peak_double12", "r_peak_double12", 0.00557/0.273*scale_double[0] );
    r_peak_double[ 0][13] = new RooRealVar( "r_peak_double13", "r_peak_double13", 0.003832/0.273*scale_double[0] );
    r_peak_double[ 0][14] = new RooRealVar( "r_peak_double14", "r_peak_double14", 0.2146/0.273*scale_double[0] );
    r_peak_double[ 1][ 0] = new RooRealVar( "r_peak_double15", "r_peak_double15", 1.993/0.273*scale_double[1] );
    r_peak_double[ 1][ 1] = new RooRealVar( "r_peak_double16", "r_peak_double16", 2/0.273*scale_double[1] );
    r_peak_double[ 1][ 2] = new RooRealVar( "r_peak_double17", "r_peak_double17", 0.8357/0.273*scale_double[1] );
    r_peak_double[ 1][ 3] = new RooRealVar( "r_peak_double18", "r_peak_double18", 0.6911/0.273*scale_double[1] );
    r_peak_double[ 1][ 4] = new RooRealVar( "r_peak_double19", "r_peak_double19", 2.378/0.273*scale_double[1] );
    r_peak_double[ 1][ 5] = new RooRealVar( "r_peak_double20", "r_peak_double20", 1.319/0.273*scale_double[1] );
    r_peak_double[ 1][ 6] = new RooRealVar( "r_peak_double21", "r_peak_double21", 1.12/0.273*scale_double[1] );
    r_peak_double[ 1][ 7] = new RooRealVar( "r_peak_double22", "r_peak_double22", 0.6334/0.273*scale_double[1] );
    r_peak_double[ 1][ 8] = new RooRealVar( "r_peak_double23", "r_peak_double23", 0.3607/0.273*scale_double[1] );
    r_peak_double[ 1][ 9] = new RooRealVar( "r_peak_double24", "r_peak_double24", 0.1977/0.273*scale_double[1] );
    r_peak_double[ 1][10] = new RooRealVar( "r_peak_double25", "r_peak_double25", 0.3837/0.273*scale_double[1] );
    r_peak_double[ 1][11] = new RooRealVar( "r_peak_double26", "r_peak_double26", 0.2227/0.273*scale_double[1] );
    r_peak_double[ 1][12] = new RooRealVar( "r_peak_double27", "r_peak_double27", 0.1186/0.273*scale_double[1] );
    r_peak_double[ 1][13] = new RooRealVar( "r_peak_double28", "r_peak_double28", 0.08219/0.273*scale_double[1] );
    r_peak_double[ 1][14] = new RooRealVar( "r_peak_double29", "r_peak_double29", 12.34/0.273*scale_double[1] );
    r_peak_double[ 2][ 0] = new RooRealVar( "r_peak_double30", "r_peak_double30", 2.021/0.273*scale_double[2] );
    r_peak_double[ 2][ 1] = new RooRealVar( "r_peak_double31", "r_peak_double31", 2.031/0.273*scale_double[2] );
    r_peak_double[ 2][ 2] = new RooRealVar( "r_peak_double32", "r_peak_double32", 0.8577/0.273*scale_double[2] );
    r_peak_double[ 2][ 3] = new RooRealVar( "r_peak_double33", "r_peak_double33", 0.7102/0.273*scale_double[2] );
    r_peak_double[ 2][ 4] = new RooRealVar( "r_peak_double34", "r_peak_double34", 2.402/0.273*scale_double[2] );
    r_peak_double[ 2][ 5] = new RooRealVar( "r_peak_double35", "r_peak_double35", 1.336/0.273*scale_double[2] );
    r_peak_double[ 2][ 6] = new RooRealVar( "r_peak_double36", "r_peak_double36", 1.132/0.273*scale_double[2] );
    r_peak_double[ 2][ 7] = new RooRealVar( "r_peak_double37", "r_peak_double37", 0.6409/0.273*scale_double[2] );
    r_peak_double[ 2][ 8] = new RooRealVar( "r_peak_double38", "r_peak_double38", 0.3723/0.273*scale_double[2] );
    r_peak_double[ 2][ 9] = new RooRealVar( "r_peak_double39", "r_peak_double39", 0.2044/0.273*scale_double[2] );
    r_peak_double[ 2][10] = new RooRealVar( "r_peak_double40", "r_peak_double40", 0.399/0.273*scale_double[2] );
    r_peak_double[ 2][11] = new RooRealVar( "r_peak_double41", "r_peak_double41", 0.2322/0.273*scale_double[2] );
    r_peak_double[ 2][12] = new RooRealVar( "r_peak_double42", "r_peak_double42", 0.1241/0.273*scale_double[2] );
    r_peak_double[ 2][13] = new RooRealVar( "r_peak_double43", "r_peak_double43", 0.08602/0.273*scale_double[2] );
    r_peak_double[ 2][14] = new RooRealVar( "r_peak_double44", "r_peak_double44", 12.55/0.273*scale_double[2] );
    //*/
  }else if( Nbin_afb == 8 ){
    // MC
    /*
    ...
    */
    // RD
    ///*
    r_peak_double[ 0][ 0] = new RooRealVar( "r_peak_double0", "r_peak_double0", 0.05064/0.273*scale_double[0] );
    r_peak_double[ 0][ 1] = new RooRealVar( "r_peak_double1", "r_peak_double1", 0.04992/0.273*scale_double[0] );
    r_peak_double[ 0][ 2] = new RooRealVar( "r_peak_double2", "r_peak_double2", 0.02482/0.273*scale_double[0] );
    r_peak_double[ 0][ 3] = new RooRealVar( "r_peak_double3", "r_peak_double3", 0.01664/0.273*scale_double[0] );
    ...
    r_peak_double[ 0][ 8] = new RooRealVar( "r_peak_double8", "r_peak_double8", 0.2146/0.273*scale_double[0] );
    r_peak_double[ 1][ 0] = new RooRealVar( "r_peak_double9", "r_peak_double9", 2.829/0.273*scale_double[1] );
    r_peak_double[ 1][ 1] = new RooRealVar( "r_peak_double10", "r_peak_double10", 2.691/0.273*scale_double[1] );
    r_peak_double[ 1][ 2] = new RooRealVar( "r_peak_double11", "r_peak_double11", 2.378/0.273*scale_double[1] );
    r_peak_double[ 1][ 3] = new RooRealVar( "r_peak_double12", "r_peak_double12", 1.319/0.273*scale_double[1] );
    ...
    r_peak_double[ 1][ 8] = new RooRealVar( "r_peak_double17", "r_peak_double17", 12.34/0.273*scale_double[1] );
    r_peak_double[ 2][ 0] = new RooRealVar( "r_peak_double18", "r_peak_double18", 2.879/0.273*scale_double[2] );
    r_peak_double[ 2][ 1] = new RooRealVar( "r_peak_double19", "r_peak_double19", 2.741/0.273*scale_double[2] );
    r_peak_double[ 2][ 2] = new RooRealVar( "r_peak_double20", "r_peak_double20", 2.402/0.273*scale_double[2] );
    r_peak_double[ 2][ 3] = new RooRealVar( "r_peak_double21", "r_peak_double21", 1.336/0.273*scale_double[2] );
    ...
    r_peak_double[ 2][ 8] = new RooRealVar( "r_peak_double26", "r_peak_double26", 12.55/0.273*scale_double[2] );
    //*/
  }
  ...
  if( Nbin_afb == 14 ){
    ...
    */
    // RD
    ///*
    r_peak_swap[ 0][ 0] = new RooRealVar( "r_peak_swap0", "r_peak_swap0", 0.004017*scale_swap[0] );
    r_peak_swap[ 0][ 1] = new RooRealVar( "r_peak_swap1", "r_peak_swap1", 0.004111*scale_swap[0] );
    r_peak_swap[ 0][ 2] = new RooRealVar( "r_peak_swap2", "r_peak_swap2", 0.02171*scale_swap[0] );
    r_peak_swap[ 0][ 3] = new RooRealVar( "r_peak_swap3", "r_peak_swap3", 0.009819*scale_swap[0] );
    r_peak_swap[ 0][ 4] = new RooRealVar( "r_peak_swap4", "r_peak_swap4", 0.03199*scale_swap[0] );
    r_peak_swap[ 0][ 5] = new RooRealVar( "r_peak_swap5", "r_peak_swap5", 0.01733*scale_swap[0] );
    r_peak_swap[ 0][ 6] = new RooRealVar( "r_peak_swap6", "r_peak_swap6", 0.002827*scale_swap[0] );
    r_peak_swap[ 0][ 7] = new RooRealVar( "r_peak_swap7", "r_peak_swap7", 0.0005247*scale_swap[0] );
    r_peak_swap[ 0][ 8] = new RooRealVar( "r_peak_swap8", "r_peak_swap8", 0*scale_swap[0] );
    r_peak_swap[ 0][ 9] = new RooRealVar( "r_peak_swap9", "r_peak_swap9", 0*scale_swap[0] );
    r_peak_swap[ 0][10] = new RooRealVar( "r_peak_swap10", "r_peak_swap10", 0*scale_swap[0] );
    r_peak_swap[ 0][11] = new RooRealVar( "r_peak_swap11", "r_peak_swap11", 0*scale_swap[0] );
    r_peak_swap[ 0][12] = new RooRealVar( "r_peak_swap12", "r_peak_swap12", 0*scale_swap[0] );
    r_peak_swap[ 0][13] = new RooRealVar( "r_peak_swap13", "r_peak_swap13", 0*scale_swap[0] );
    r_peak_swap[ 0][14] = new RooRealVar( "r_peak_swap14", "r_peak_swap14", 0.09232*scale_swap[0] );
    r_peak_swap[ 1][ 0] = new RooRealVar( "r_peak_swap15", "r_peak_swap15", 0.1488*scale_swap[1] );
    r_peak_swap[ 1][ 1] = new RooRealVar( "r_peak_swap16", "r_peak_swap16", 0.1641*scale_swap[1] );
    r_peak_swap[ 1][ 2] = new RooRealVar( "r_peak_swap17", "r_peak_swap17", 0.2987*scale_swap[1] );
    r_peak_swap[ 1][ 3] = new RooRealVar( "r_peak_swap18", "r_peak_swap18", 0.3332*scale_swap[1] );
    r_peak_swap[ 1][ 4] = new RooRealVar( "r_peak_swap19", "r_peak_swap19", 1.807*scale_swap[1] );
    r_peak_swap[ 1][ 5] = new RooRealVar( "r_peak_swap20", "r_peak_swap20", 1.013*scale_swap[1] );
    r_peak_swap[ 1][ 6] = new RooRealVar( "r_peak_swap21", "r_peak_swap21", 0.09681*scale_swap[1] );
    r_peak_swap[ 1][ 7] = new RooRealVar( "r_peak_swap22", "r_peak_swap22", 0.06818*scale_swap[1] );
    r_peak_swap[ 1][ 8] = new RooRealVar( "r_peak_swap23", "r_peak_swap23", 0*scale_swap[1] );
    r_peak_swap[ 1][ 9] = new RooRealVar( "r_peak_swap24", "r_peak_swap24", 0*scale_swap[1] );
    r_peak_swap[ 1][10] = new RooRealVar( "r_peak_swap25", "r_peak_swap25", 0*scale_swap[1] );
    r_peak_swap[ 1][11] = new RooRealVar( "r_peak_swap26", "r_peak_swap26", 0*scale_swap[1] );
    r_peak_swap[ 1][12] = new RooRealVar( "r_peak_swap27", "r_peak_swap27", 0*scale_swap[1] );
    r_peak_swap[ 1][13] = new RooRealVar( "r_peak_swap28", "r_peak_swap28", 0*scale_swap[1] );
    r_peak_swap[ 1][14] = new RooRealVar( "r_peak_swap29", "r_peak_swap29", 3.93*scale_swap[1] );
    r_peak_swap[ 2][ 0] = new RooRealVar( "r_peak_swap30", "r_peak_swap30", 0.1528*scale_swap[2] );
    r_peak_swap[ 2][ 1] = new RooRealVar( "r_peak_swap31", "r_peak_swap31", 0.1683*scale_swap[2] );
    r_peak_swap[ 2][ 2] = new RooRealVar( "r_peak_swap32", "r_peak_swap32", 0.3204*scale_swap[2] );
    r_peak_swap[ 2][ 3] = new RooRealVar( "r_peak_swap33", "r_peak_swap33", 0.343*scale_swap[2] );
    r_peak_swap[ 2][ 4] = new RooRealVar( "r_peak_swap34", "r_peak_swap34", 1.839*scale_swap[2] );
    r_peak_swap[ 2][ 5] = new RooRealVar( "r_peak_swap35", "r_peak_swap35", 1.03*scale_swap[2] );
    r_peak_swap[ 2][ 6] = new RooRealVar( "r_peak_swap36", "r_peak_swap36", 0.09964*scale_swap[2] );
    r_peak_swap[ 2][ 7] = new RooRealVar( "r_peak_swap37", "r_peak_swap37", 0.0687*scale_swap[2] );
    r_peak_swap[ 2][ 8] = new RooRealVar( "r_peak_swap38", "r_peak_swap38", 0*scale_swap[2] );
    r_peak_swap[ 2][ 9] = new RooRealVar( "r_peak_swap39", "r_peak_swap39", 0*scale_swap[2] );
    r_peak_swap[ 2][10] = new RooRealVar( "r_peak_swap40", "r_peak_swap40", 0*scale_swap[2] );
    r_peak_swap[ 2][11] = new RooRealVar( "r_peak_swap41", "r_peak_swap41", 0*scale_swap[2] );
    r_peak_swap[ 2][12] = new RooRealVar( "r_peak_swap42", "r_peak_swap42", 0*scale_swap[2] );
    r_peak_swap[ 2][13] = new RooRealVar( "r_peak_swap43", "r_peak_swap43", 0*scale_swap[2] );
    r_peak_swap[ 2][14] = new RooRealVar( "r_peak_swap44", "r_peak_swap44", 4.022*scale_swap[2] );
    //*/
  }else if( Nbin_afb == 8 ){
    // MC
    /*
    ...
    */
    // RD
    ///*
    r_peak_swap[ 0][ 0] = new RooRealVar( "r_peak_swap0", "r_peak_swap0", 0.02572*scale_swap[0] );
    r_peak_swap[ 0][ 1] = new RooRealVar( "r_peak_swap1", "r_peak_swap1", 0.01393*scale_swap[0] );
    r_peak_swap[ 0][ 2] = new RooRealVar( "r_peak_swap2", "r_peak_swap2", 0.03199*scale_swap[0] );
    r_peak_swap[ 0][ 3] = new RooRealVar( "r_peak_swap3", "r_peak_swap3", 0.01733*scale_swap[0] );
    ...
    r_peak_swap[ 0][ 8] = new RooRealVar( "r_peak_swap8", "r_peak_swap8", 0.09232*scale_swap[0] );
    r_peak_swap[ 1][ 0] = new RooRealVar( "r_peak_swap9", "r_peak_swap9", 0.4475*scale_swap[1] );
    r_peak_swap[ 1][ 1] = new RooRealVar( "r_peak_swap10", "r_peak_swap10", 0.4973*scale_swap[1] );
    r_peak_swap[ 1][ 2] = new RooRealVar( "r_peak_swap11", "r_peak_swap11", 1.807*scale_swap[1] );
    r_peak_swap[ 1][ 3] = new RooRealVar( "r_peak_swap12", "r_peak_swap12", 1.013*scale_swap[1] );
    ...
    r_peak_swap[ 1][ 8] = new RooRealVar( "r_peak_swap17", "r_peak_swap17", 3.93*scale_swap[1] );
    r_peak_swap[ 2][ 0] = new RooRealVar( "r_peak_swap18", "r_peak_swap18", 0.4732*scale_swap[2] );
    r_peak_swap[ 2][ 1] = new RooRealVar( "r_peak_swap19", "r_peak_swap19", 0.5112*scale_swap[2] );
    r_peak_swap[ 2][ 2] = new RooRealVar( "r_peak_swap20", "r_peak_swap20", 1.839*scale_swap[2] );
    r_peak_swap[ 2][ 3] = new RooRealVar( "r_peak_swap21", "r_peak_swap21", 1.03*scale_swap[2] );
    ...
    r_peak_swap[ 2][ 8] = new RooRealVar( "r_peak_swap26", "r_peak_swap26", 4.022*scale_swap[2] );
    //*/
  }
  ...
  */
  ...
  if( flag_save ){
    TFile outfile( Form("pic/%s_fit_bin_dt_func%d_%dq2_double_cnt%d.root",  axis, sel_fun, fl_q2bin, fl_syst), "RECREATE" );
    for( Int_t i=0; i<Nroohist; i++ ){
    ...
    c2->Print( Form("pic/%s_fit_bin_dt_func%d_%dq2_c2_double_cnt%d.eps",  axis, sel_fun, fl_q2bin, fl_syst) );
    c2->Write();

    c3->Print( Form("pic/%s_fit_bin_dt_func%d_%dq2_c3_double_cnt%d.eps",  axis, sel_fun, fl_q2bin, fl_syst) );
    c3->Write();

...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  const Double_t x[ng][nafb] = {
    ...
    {4.3/2.0, (4.3 + div[2][0])/2.0,  (div[2][1] + div[2][2])/2.0, (div[2][3] + 25.0)/2.0}, // ll // modified @ 20130812
  ...
  TGraphErrors** gm = new TGraphErrors*[ng];
  ...
  // SAVE
  if( fl_save ) c1->Print( "pic/q2_AFB.eps" );

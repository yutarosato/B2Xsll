...
TComplex GetC7Eff0(Double_t sh,
		   Double_t r_a7, Double_t r_a9, Double_t r_a10,
		   Bool_t nnlo=true) 
{
  // This function returns the zeroth-order alpha_s part of C7
  
  //if (!nnlo) return -0.313;
  if (!nnlo) return -0.313*r_a7; // scaling from SM
  ...
  //A7 = -0.353 + 0.023;
  A7 = r_a7*(-0.353 + 0.023); // scaling from SM
  ...
  //A7 = -0.312 + 0.008;
  A7 = r_a7*(-0.312 + 0.008); // scaling from SM
  c7eff = A7;
...
TComplex GetC7Eff1(Double_t sh, Double_t mbeff, Bool_t nnlo=true) 
{
  ...
  //double A7 = (-0.312 + 0.008)*r_a7; // scaling from SM
  Double_t A8 = -0.148;
  //double A9  = (4.174 + (-0.035))*r_a9 ; // scaling from SM
  //double A10 = (-4.592 + 0.379  )*r_a10; // scaling from SM
  Double_t C1 = -0.487;
  Double_t C2 = 1.024;
		   ...
		   Bool_t nnlo=true, Bool_t btod=false) 
{
  ...
  if (!nnlo) return r_a9*4.344; // scaling from SM
  Double_t logsh;
  logsh = log(sh);
  Double_t mch = 0.29;
  ...
  Double_t A9;
  //A9 = 4.287 + (-0.218);
  A9 = r_a9*(4.287 + (-0.218)); // scaling from SM
  Double_t A10;
  A10 = r_a10*(-4.592 + 0.379); // scaling from SM
  //A10 = -4.592 + 0.379;
  Double_t C1;
  C1 = -0.697;
  Double_t C2;
  ...
  alphas = 0.215;
  //A9 = 4.174 + (-0.035);
  A9 = r_a9*(4.174 + (-0.035)); // scaling from SM
  C1 = -0.487;
  C2 = 1.024;
  A8 = -0.148;
  T9 = 0.374 + 0.252;
...
TComplex GetC10Eff(Double_t sh,
		   Double_t r_a7, Double_t r_a9, Double_t r_a10,
		   Bool_t nnlo=true) 
{
  
  //if (!nnlo) return -4.669;
  if (!nnlo) return -4.669*r_a10; // scaling from SM
  TComplex A10;
  //A10 = -4.592 + 0.379;
  A10 = (-4.592 + 0.379)*r_a10; // scaling from SM
...
Double_t d2gdsdz( const Double_t* x, const Double_t* p){ // x[0] = s(=q^2), x[1] = z(=cos_theta)
  ...
  if( sh>0.25 ) alphas = 0.267; // muscale = 2.5 GeV
  TComplex c7eff0 = GetC7Eff0( sh,        p[1], p[2], p[3], nnlo       );
  TComplex c7eff1 = GetC7Eff1( sh, mbeff,                   nnlo       );
  TComplex c9eff0 = GetC9Eff0( sh, mbeff, p[1], p[2], p[3], nnlo, btod );
  TComplex c9eff1 = GetC9Eff1( sh, mbeff,                   nnlo, btod );
  TComplex c10eff = GetC10Eff( sh,        p[1], p[2], p[3], nnlo       );
...
TGraph* q2_AFB_PRD66094013( Double_t r_a7, Double_t r_a9, Double_t r_a10, Double_t npoint=115 ){
  TGraph* g = new TGraph();
  TF2* fd2gdsdz = new TF2( "fd2gdsdz", d2gdsdz, xmin, xmax[0], ymin, ymax, 4 );
  fd2gdsdz->SetParameter( 0,0     );
  fd2gdsdz->SetParameter( 1,r_a7  );
  fd2gdsdz->SetParameter( 2,r_a9  );
  fd2gdsdz->SetParameter( 3,r_a10 );
...
TGraphErrors* q2_AFB_bin_PRD66094013( Int_t fl_lep, Double_t r_a7, Double_t r_a9, Double_t r_a10, Double_t npoint=115 ){
...
TGraph* q2_PRD66094013( Double_t r_a7, Double_t r_a9, Double_t r_a10, Double_t npoint=115 ){
  TGraph* g = new TGraph();
  TF2* fd2gdsdz = new TF2( "fd2gdsdz", d2gdsdz, xmin, xmax[0], ymin, ymax, 4 );
  fd2gdsdz->SetParameter( 0,0     );
  fd2gdsdz->SetParameter( 1,r_a7  );
...
TGraph* q2_AFB_eff_PRD66094013( Int_t fl_lep, Double_t r_a7, Double_t r_a9, Double_t r_a10, Double_t npoint=70 ){
...
TGraphErrors* q2_AFB_bin_eff_PRD66094013( Int_t fl_lep, Double_t r_a7, Double_t r_a9, Double_t r_a10, Double_t npoint=115 ){
...
TGraph* q2_AFB_PRD59074013( Double_t r_a7, Double_t r_a9, Double_t r_a10, Double_t npoint=210 ){
  TGraph* g = new TGraph();
  TF2* fd2bdsdz = new TF2( "fd2bdsdz", d2bdsdz, xmin, xmax[1], ymin, ymax, 4 );
  fd2bdsdz->SetParameter( 1, r_a7  );
  fd2bdsdz->SetParameter( 2, r_a9  );
  fd2bdsdz->SetParameter( 3, r_a10 );
  Double_t step = (xmax[0]-xmin)/npoint;
  for( Int_t i=0; i<npoint; i++ ){
...
TGraphErrors* q2_AFB_bin_PRD59074013( Int_t fl_lep, Double_t r_a7, Double_t r_a9, Double_t r_a10, Double_t npoint=210 ){
  TGraphErrors* g = new TGraphErrors();
  TF2* fd2bdsdz = new TF2( "fd2bdsdz", d2bdsdz, xmin, xmax[1], ymin, ymax, 4 );
  fd2bdsdz->SetParameter( 1, r_a7  );
  fd2bdsdz->SetParameter( 2, r_a9  );
...
TGraph* q2_PRD59074013( Double_t r_a7, Double_t r_a9, Double_t r_a10, Double_t npoint=210 ){
  TGraph* g = new TGraph();
  TF2* fd2bdsdz = new TF2( "fd2bdsdz", d2bdsdz, xmin, xmax[1], ymin, ymax, 4 );
...
TGraph* q2_AFB_eff_PRD59074013( Int_t fl_lep, Double_t r_a7, Double_t r_a9, Double_t r_a10, Double_t npoint=70 ){
  const Int_t nybin = 30; // fixed
  ...
  fd2bdsdz->SetParameter( 2,r_a9  );
  fd2bdsdz->SetParameter( 3,r_a10 );
  Double_t stepx = (xmax[1]-xmin)/npoint;
  Double_t stepy = (ymax-ymin)/(Double_t)nybin;
  Int_t    cnt   = 0;
  for( Int_t i=0; i<npoint; i++ ){
    Double_t nf = 0;
...
TGraphErrors* q2_AFB_bin_eff_PRD59074013( Int_t fl_lep, Double_t r_a7, Double_t r_a9, Double_t r_a10, Double_t npoint=210 ){
...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  Style();
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  if( argc!=4 ) std::cerr << "Wrong input" << std::endl, abort();
  Double_t r_a7  = atof(argv[1])/100;
  Double_t r_a9  = atof(argv[2])/100;
  Double_t r_a10 = atof(argv[3])/100;
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  TF2* f1_1 = new TF2( "f1_1", d2gdsdz, xmin, xmax[0], ymin, ymax, 4 ); f1_1->SetTitle( "q^{2} - cos#theta (1st term:c9,c10)" ); f1_1->SetParameters( 1, r_a7, r_a9, r_a10 ); c1->cd( 6); f1_1->Draw("colz");
  TF2* f1_2 = new TF2( "f1_2", d2gdsdz, xmin, xmax[0], ymin, ymax, 4 ); f1_2->SetTitle( "q^{2} - cos#theta (2nd term:c7)"     ); f1_2->SetParameters( 2, r_a7, r_a9, r_a10 ); c1->cd( 7); f1_2->Draw("colz");
  TF2* f1_3 = new TF2( "f1_3", d2gdsdz, xmin, xmax[0], ymin, ymax, 4 ); f1_3->SetTitle( "q^{2} - cos#theta (3rd term:c9c10)"  ); f1_3->SetParameters( 3, r_a7, r_a9, r_a10 ); c1->cd( 8); f1_3->Draw("colz");
  TF2* f1_4 = new TF2( "f1_4", d2gdsdz, xmin, xmax[0], ymin, ymax, 4 ); f1_4->SetTitle( "q^{2} - cos#theta (4th term:c7c9)"   ); f1_4->SetParameters( 4, r_a7, r_a9, r_a10 ); c1->cd( 9); f1_4->Draw("colz");
  TF2* f1_5 = new TF2( "f1_5", d2gdsdz, xmin, xmax[0], ymin, ymax, 4 ); f1_5->SetTitle( "q^{2} - cos#theta (5th term:c7c10)"  ); f1_5->SetParameters( 5, r_a7, r_a9, r_a10 ); c1->cd(10); f1_5->Draw("colz");
  TF2* f1   = new TF2( "f1",   d2gdsdz, xmin, xmax[0], ymin, ymax, 4 ); f1  ->SetTitle( "q^{2} - cos#theta"                   ); f1  ->SetParameters( 0, r_a7, r_a9, r_a10 ); c1->cd(11); f1  ->Draw("colz"); // surf3
  c1->cd(12); fLi2->Draw();
  c1->cd(13);

  TGraph*       g1_afb_true          = q2_AFB_PRD66094013        (   r_a7, r_a9, r_a10);  g1_afb_true         ->SetLineColor(1);
  TGraphErrors* g1_afb_bin_true_lep1 = q2_AFB_bin_PRD66094013    (1, r_a7, r_a9, r_a10); g1_afb_bin_true_lep1->SetLineColor(2); g1_afb_bin_true_lep1->SetMarkerColor(2);
  TGraphErrors* g1_afb_bin_true_lep0 = q2_AFB_bin_PRD66094013    (0, r_a7, r_a9, r_a10); g1_afb_bin_true_lep0->SetLineColor(3); g1_afb_bin_true_lep0->SetMarkerColor(3);
  TGraph*       g1_afb_obs_lep1      = q2_AFB_eff_PRD66094013    (1, r_a7, r_a9, r_a10); g1_afb_obs_lep1     ->SetLineColor(2);
  TGraph*       g1_afb_obs_lep0      = q2_AFB_eff_PRD66094013    (0, r_a7, r_a9, r_a10); g1_afb_obs_lep0     ->SetLineColor(3);
  TGraphErrors* g1_afb_bin_obs_lep1  = q2_AFB_bin_eff_PRD66094013(1, r_a7, r_a9, r_a10); g1_afb_bin_obs_lep1 ->SetLineColor(2); g1_afb_bin_obs_lep1->SetMarkerColor(2); g1_afb_bin_obs_lep1->SetMarkerStyle(24);
  TGraphErrors* g1_afb_bin_obs_lep0  = q2_AFB_bin_eff_PRD66094013(0, r_a7, r_a9, r_a10); g1_afb_bin_obs_lep0 ->SetLineColor(3); g1_afb_bin_obs_lep0->SetMarkerColor(3); g1_afb_bin_obs_lep0->SetMarkerStyle(24);
  g1_afb_true         ->Draw("AC"   );
  ...
  c1->cd(14);
  TGraph* g1_q2 = q2_PRD66094013( r_a7, r_a9, r_a10, 100 );
  g1_q2->Draw("AC");

  c1->Print( Form("pic/theory_curve_dev_%d_%d_%d_c1.eps", atoi(argv[1]), atoi(argv[2]), atoi(argv[3])) );  


  TCanvas* c2 = Canvas( "c2", "c2", 2, 2 );

  TF2* f2 = new TF2( "f2",  d2bdsdz, xmin, xmax[1], ymin, ymax, 4 );
  f2->SetParameters( 0, r_a7, r_a9, r_a10 );
  f2->SetTitle( "q^{2} - cos#theta" );
  c2->cd(1);
  f2->Draw("colz"); // surf3
  
  c2->cd(2);
  TGraph* g2_afb_true          = q2_AFB_PRD59074013        (   r_a7, r_a9, r_a10);  g2_afb_true         ->SetName( "afb_true"          ); g2_afb_true         ->SetLineColor(1);
  TGraph* g2_afb_bin_true_lep1 = q2_AFB_bin_PRD59074013    (1, r_a7, r_a9, r_a10); g2_afb_bin_true_lep1->SetName( "afb_bin_true_lep1" ); g2_afb_bin_true_lep1->SetLineColor(2); g2_afb_bin_true_lep1->SetMarkerColor(2);
  TGraph* g2_afb_bin_true_lep0 = q2_AFB_bin_PRD59074013    (0, r_a7, r_a9, r_a10); g2_afb_bin_true_lep0->SetName( "afb_bin_true_lep0" ); g2_afb_bin_true_lep0->SetLineColor(3); g2_afb_bin_true_lep0->SetMarkerColor(3);
  TGraph* g2_afb_obs           = q2_AFB_eff_PRD59074013    (2, r_a7, r_a9, r_a10); g2_afb_obs          ->SetName( "afb_obs"           ); g2_afb_obs          ->SetLineColor(1);
  TGraph* g2_afb_obs_lep1      = q2_AFB_eff_PRD59074013    (1, r_a7, r_a9, r_a10); g2_afb_obs_lep1     ->SetName( "afb_obs_lep1"      ); g2_afb_obs_lep1     ->SetLineColor(2);
  TGraph* g2_afb_obs_lep0      = q2_AFB_eff_PRD59074013    (0, r_a7, r_a9, r_a10); g2_afb_obs_lep0     ->SetName( "afb_obs_lep0"      ); g2_afb_obs_lep0     ->SetLineColor(3);
  TGraph* g2_afb_bin_obs_lep1  = q2_AFB_bin_eff_PRD59074013(1, r_a7, r_a9, r_a10); g2_afb_bin_obs_lep1 ->SetName( "afb_bin_obs_lep1"  ); g2_afb_bin_obs_lep1 ->SetLineColor(2); g2_afb_bin_obs_lep1->SetMarkerColor(2); g2_afb_bin_obs_lep1->SetMarkerStyle(24);
  TGraph* g2_afb_bin_obs_lep0  = q2_AFB_bin_eff_PRD59074013(0, r_a7, r_a9, r_a10); g2_afb_bin_obs_lep0 ->SetName( "afb_bin_obs_lep0"  ); g2_afb_bin_obs_lep0 ->SetLineColor(3); g2_afb_bin_obs_lep0->SetMarkerColor(3); g2_afb_bin_obs_lep0->SetMarkerStyle(24);
  ...
  c2->cd(3);
  TGraph* g2_q2 = q2_PRD59074013( r_a7, r_a9, r_a10, 100 );
  g2_q2->Draw("AC");

  c2->Print( Form("pic/theory_curve_dev_%d_%d_%d_c2.eps", atoi(argv[1]), atoi(argv[2]), atoi(argv[3])) );  
  ...
  g2_afb_bin_obs_lep1 ->Draw("Psame");
  g2_afb_bin_obs_lep0 ->Draw("Psame");
  c3->Print( Form("pic/theory_curve_dev_%d_%d_%d_c3.eps", atoi(argv[1]), atoi(argv[2]), atoi(argv[3])) );  

  TFile outfile( Form("pic/theory_curve_dev_%d_%d_%d.root",atoi(argv[1]), atoi(argv[2]), atoi(argv[3])), "RECREATE" );
  c1->Write();
  c2->Write();
  g2_afb_true         ->Write();
  g2_afb_obs          ->Write();
  ...
  ofstream fout;
  fout.open ( Form("log/theory_curve_dev_%4.2f_%4.2f_%4.2f.log", r_a7, r_a9, r_a10) );
  fout << g2_afb_bin_true_lep1->GetY()[1] << "\t"
       << g2_afb_bin_true_lep0->GetY()[1] << "\t"
       << g2_afb_bin_true_lep0->GetY()[1]/g2_afb_bin_true_lep1->GetY()[1] << "\t"
       << r_a7  << "\t"
       << r_a9  << "\t"
       << r_a10 << "\t"
       << "HOGE2"
       << std::endl;
  fout << g2_afb_bin_true_lep1->GetY()[3] << "\t"
       << g2_afb_bin_true_lep0->GetY()[3] << "\t"
       << g2_afb_bin_true_lep0->GetY()[3]/g2_afb_bin_true_lep1->GetY()[3] << "\t"
       << r_a7  << "\t"
       << r_a9  << "\t"
       << r_a10 << "\t"
       << "HOGE3"

...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  sig_mean     [0] = new RooRealVar ( "#mu0",          "#mu",          5.27936+gRandom->Gaus(0, 0.00002) ); // RD
  sig_mean     [1] = new RooRealVar ( "#mu1",          "#mu",          5.27932+gRandom->Gaus(0, 0.00002) ); // RD
  sig_mean     [2] = new RooRealVar ( "#mu2",          "#mu",          5.27934+gRandom->Gaus(0, 0.00002) ); // RD
  sig_sigma    [0] = new RooRealVar ( "#sigma0",       "#sigma",       0.00267+gRandom->Gaus(0, 0.00002) ); // RD
  sig_sigma    [1] = new RooRealVar ( "#sigma1",       "#sigma",       0.00258+gRandom->Gaus(0, 0.00002) ); // RD
  sig_sigma    [2] = new RooRealVar ( "#sigma2",       "#sigma",       0.00263+gRandom->Gaus(0, 0.00002) ); // RD
  sig_mean_sim [0] = new RooRealVar ( "#mu0^{sim}",    "#mu^{sim}",    5.27936+gRandom->Gaus(0, 0.00002) ); // RD
  sig_mean_sim [1] = new RooRealVar ( "#mu1^{sim}",    "#mu^{sim}",    5.27932+gRandom->Gaus(0, 0.00002) ); // RD
  sig_mean_sim [2] = new RooRealVar ( "#mu2^{sim}",    "#mu^{sim}",    5.27934+gRandom->Gaus(0, 0.00002) ); // RD
  sig_sigma_sim[0] = new RooRealVar ( "#sigma0^{sim}", "#sigma^{sim}", 0.00267+gRandom->Gaus(0, 0.00002) ); // RD
  sig_sigma_sim[1] = new RooRealVar ( "#sigma1^{sim}", "#sigma^{sim}", 0.00258+gRandom->Gaus(0, 0.00002) ); // RD
  sig_sigma_sim[2] = new RooRealVar ( "#sigma2^{sim}", "#sigma^{sim}", 0.00263+gRandom->Gaus(0, 0.00002) ); // RD
  ...
  */
  ...
  if( flag_save ){
    TFile outfile( Form("pic/%s_fit_bin_dt_func%d_%dq2_sigshape_cnt%d.root",  axis, sel_fun, fl_q2bin, fl_cnt), "RECREATE" );
    for( Int_t i=0; i<Nroohist; i++ ){
    ...
    c2->Print( Form("pic/%s_fit_bin_dt_func%d_%dq2_c2_sigshape_cnt%d.eps",  axis, sel_fun, fl_q2bin, fl_cnt) );
    c2->Write();

    c3->Print( Form("pic/%s_fit_bin_dt_func%d_%dq2_c3_sigshape_cnt%d.eps",  axis, sel_fun, fl_q2bin, fl_cnt) );
    c3->Write();

...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  if( !flag_roof ){
	...
	Int_t k = n + 2*m;
	c1[m][n]->Update();
	if( fl_q2bin==0 ) c1[m][n]->Print( Form("pic/%s_fit_bin_dt_kstrll_func%d_c1_%d.eps",  axis, sel_fun, k+1) );
      }
    }
  ...
  TFile file_scf("pdf_data_kstrll/Mbc_self_cf2_setA-U.root");
  ...
  for( Int_t i=0; i<Nroohist; i++ ){
    ...
    for( Int_t j=0; j<Nbin_afb/2; j++ ){
      ...
      Double_t tmp_nsig_q2 = 10;
      Double_t tmp_AFB     =  0;
      nsig_q2    [i][j] = new RooRealVar( Form("N_{sig}^{q^{2}}%d_%d",    i,j), Form("N_{sig}^{q^{2}}%d_%d",    i,j), tmp_nsig_q2, tmp_nsig_q2-20, tmp_nsig_q2+50 );
      nsig_q2_sim[i][j] = new RooRealVar( Form("N_{sig}^{q^{2},sim}%d_%d",i,j), Form("N_{sig}^{q^{2},sim}%d_%d",i,j), tmp_nsig_q2, tmp_nsig_q2-20, tmp_nsig_q2+50 );
  ...
  for( Int_t i=0; i<Nroohist; i++ ){
    ...
    for( Int_t j=0; j<Nbin_afb; j++ ){
      Double_t tmp_nbkg = 100;
      nbkg    [i][j] = new RooRealVar ( Form("N_{bkg}%d_%d",      i,j), Form("N_{bkg}%d_%d",      i,j), tmp_nbkg, tmp_nbkg-100, tmp_nbkg+300 );
      nbkg_sim[i][j] = new RooRealVar ( Form("N_{bkg}^{sim}%d_%d",i,j), Form("N_{bkg}^{sim}%d_%d",i,j), tmp_nbkg, tmp_nbkg-100, tmp_nbkg+300 );
    }
  }

  //nbkg_sim[1][5]->setVal(0.0); nbkg_sim[1][5]->setConstant(kTRUE);
  //nbkg    [1][5]->setVal(0.0); nbkg    [1][5]->setConstant(kTRUE);
  ...
  TFile file_cc("pdf_data_kstrll/Mbc_peak_cc2_s00.root"); // CC-MC
  ...
  r_peak_cc[ 0][ 0] = new RooRealVar( "r_peak_cc0", "r_peak_cc0", scale_cc[0]*0.05 );
  r_peak_cc[ 0][ 1] = new RooRealVar( "r_peak_cc1", "r_peak_cc1", scale_cc[0]*0.04 );
  r_peak_cc[ 0][ 2] = new RooRealVar( "r_peak_cc2", "r_peak_cc2", scale_cc[0]*1.17 );
  r_peak_cc[ 0][ 3] = new RooRealVar( "r_peak_cc3", "r_peak_cc3", scale_cc[0]*1.24 );
  r_peak_cc[ 0][ 4] = new RooRealVar( "r_peak_cc4", "r_peak_cc4", scale_cc[0]*0.42 );
  r_peak_cc[ 0][ 5] = new RooRealVar( "r_peak_cc5", "r_peak_cc5", scale_cc[0]*0.34 );
  ...
  r_peak_cc[ 0][ 8] = new RooRealVar( "r_peak_cc8", "r_peak_cc8", scale_cc[0]*3.26 );
  r_peak_cc[ 1][ 0] = new RooRealVar( "r_peak_cc9", "r_peak_cc9", scale_cc[1]*0.03 );
  r_peak_cc[ 1][ 1] = new RooRealVar( "r_peak_cc10", "r_peak_cc10", scale_cc[1]*0.03 );
  r_peak_cc[ 1][ 2] = new RooRealVar( "r_peak_cc11", "r_peak_cc11", scale_cc[1]*1.31 );
  r_peak_cc[ 1][ 3] = new RooRealVar( "r_peak_cc12", "r_peak_cc12", scale_cc[1]*1.28 );
  r_peak_cc[ 1][ 4] = new RooRealVar( "r_peak_cc13", "r_peak_cc13", scale_cc[1]*0.18 );
  r_peak_cc[ 1][ 5] = new RooRealVar( "r_peak_cc14", "r_peak_cc14", scale_cc[1]*0.21 );
  r_peak_cc[ 1][ 6] = new RooRealVar( "r_peak_cc15", "r_peak_cc15", scale_cc[1]*0 );
  r_peak_cc[ 1][ 7] = new RooRealVar( "r_peak_cc16", "r_peak_cc16", scale_cc[1]*0 );
  r_peak_cc[ 1][ 8] = new RooRealVar( "r_peak_cc17", "r_peak_cc17", scale_cc[1]*3.04 );
  r_peak_cc[ 2][ 0] = new RooRealVar( "r_peak_cc18", "r_peak_cc18", scale_cc[2]*0.08 );
  r_peak_cc[ 2][ 1] = new RooRealVar( "r_peak_cc19", "r_peak_cc19", scale_cc[2]*0.07 );
  r_peak_cc[ 2][ 2] = new RooRealVar( "r_peak_cc20", "r_peak_cc20", scale_cc[2]*2.48 );
  r_peak_cc[ 2][ 3] = new RooRealVar( "r_peak_cc21", "r_peak_cc21", scale_cc[2]*2.52 );
  r_peak_cc[ 2][ 4] = new RooRealVar( "r_peak_cc22", "r_peak_cc22", scale_cc[2]*0.6 );
  r_peak_cc[ 2][ 5] = new RooRealVar( "r_peak_cc23", "r_peak_cc23", scale_cc[2]*0.55 );
  r_peak_cc[ 2][ 6] = new RooRealVar( "r_peak_cc24", "r_peak_cc24", scale_cc[2]*0 );
  r_peak_cc[ 2][ 7] = new RooRealVar( "r_peak_cc25", "r_peak_cc25", scale_cc[2]*0 );
  r_peak_cc[ 2][ 8] = new RooRealVar( "r_peak_cc26", "r_peak_cc26", scale_cc[2]*6.3 );
  ...
  TFile file_double("pdf_data_kstrll/Mbc_peak_double2_s00.root"); // RD
  ...
  TFile file_swap("pdf_data_kstrll/Mbc_peak_swap2_s00.root"); // RD
  ...
  for( Int_t i=0; i<Nroohist; i++ ){
    ...
    for( Int_t j=0; j<Nbin_afb; j++ ){
      Int_t k = j + i*Nbin_afb;
      if( fl_q2bin!=3 ){
	pdf    [i][j] = new RooAddPdf( Form("pdf%d",    k), Form("pdf%d",    k), RooArgList(*gauss    [i], *modargus    [i][j], *pdf_scf_tt    [i][j], *pdf_scf_tf    [i][j], *pdf_peak_cc    [i][j], *pdf_peak_double    [i][j]), RooArgList(*nsig     [i][j], *nbkg    [i][j], *nsig_tt    [i][j], *nsig_tf    [i][j], *r_peak_cc[i][j], *r_peak_double[i][j] ) ); // signal + scf + peak
	pdf_sim[i][j] = new RooAddPdf( Form("pdf_sim%d",k), Form("pdf_sim%d",k), RooArgList(*gauss_sim[i], *modargus_sim[i][j], *pdf_scf_tt_sim[i][j], *pdf_scf_tf_sim[i][j], *pdf_peak_cc_sim[i][j], *pdf_peak_double_sim[i][j]), RooArgList(*nsig_sim [i][j], *nbkg_sim[i][j], *nsig_tt_sim[i][j], *nsig_tf_sim[i][j], *r_peak_cc[i][j], *r_peak_double[i][j] ) ); // signal + scf + peak
      }else{
  ...
  for( Int_t i=0; i<Nroohist; i++ ){
	...
	if     ( j== 0 ) data[i]->plotOn ( frame[i][j], Binning(xbin), LineWidth(1), Cut( Form("bin%d==bin%d::12_p" ,i,i) ) );
      ...
      tag[i]->setIndex(j+1); tot_pdf[i]->plotOn ( frame[i][j], Slice(*tag[i]), ProjWData(*tag[i],*data[i]), Components( RooArgSet(*pdf_peak_cc[i][j], *pdf_peak_double[i][j]) ), LineStyle(7), LineColor(6), LineWidth(1) ); // peak
  ...
  for( Int_t i=0; i<2; i++ ){
	...
	if( i==0 ){
      ...
      if( fl_q2bin!=3 ){
	tag_sim->setIndex(i==0 ? 100+j+1 : j+1); tot_pdf_sim->plotOn ( frame_sim[i][j], Slice(*tag_sim), ProjWData(*tag_sim,*data_sim), Components( RooArgSet(*pdf_peak_cc_sim[i][j],*pdf_peak_double_sim[i][j]) ), LineStyle(7), LineColor(6), LineWidth(1) ); // peak
      }else{
  ...
  */
  ...
  if( flag_save ){
    TFile outfile( Form("pic/%s_fit_bin_dt_kstrll_func%d_%dq2.root",  axis, sel_fun, fl_q2bin), "RECREATE" );
    for( Int_t i=0; i<Nroohist; i++ ){
      for( Int_t j=0; j<2; j++ ){ // [hist, fitted hist]
	Int_t k = j + 2*i;
	if( fl_q2bin==0 ) c1[i][j]->Print( Form("pic/%s_fit_bin_dt_kstrll_func%d_c1_%d.eps",  axis, sel_fun, k+1) );
	if( fl_q2bin==0 ) c1[i][j]->Write();
      }
    }

    c2->Print( Form("pic/%s_fit_bin_dt_kstrll_func%d_%dq2_c2.eps",  axis, sel_fun, fl_q2bin) );
    c2->Write();

    c3->Print( Form("pic/%s_fit_bin_dt_kstrll_func%d_%dq2_c3.eps",  axis, sel_fun, fl_q2bin) );
    c3->Write();
    //c4->Print( Form("pic/%s_fit_bin_dt_kstrll_func%d_%dq2_c4.eps",  axis, sel_fun, fl_q2bin) );
    //c4->Write();

...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  for( Int_t i=0; i<Nchain; i++ ){
    ...
    if     ( i%Ncategory== 0 ) sTmp << "  (lpgt==3 && lmgt==3 ) && (lpself==1 && lmself==1) && korg==lporg && lporg==lmorg && abs(pi1org)==lporg && abs(pi2org)==lporg && abs(pi3org)==lporg && abs(pi4org)==lporg && rest_sw==0 && gm_bg1<3 && ( pi0org==1 || (pi0org<0.5&&rm_xs>999) || (pi0org<0.5&&rm_xs<999))"; // charmonium events(right-pi0)
    ...
    /* // tmppppp
    if     ( i%Ncategory== 0 ) sTmp << "  (lpgt==3 && lmgt==3 ) &&  (lpself==1 && lmself==1 && korg==lporg && lporg==lmorg && abs(pi1org)==lporg && abs(pi2org)==lporg && abs(pi3org)==lporg && abs(pi4org)==lporg && rest_sw==0 && gm_bg1<10 && pi0org== 1) ";                // charmonium events(right-pi0)
    else if( i%Ncategory== 1 ) sTmp << "  (lpgt==3 && lmgt==3 ) &&  (lpself==1 && lmself==1 && korg==lporg && lporg==lmorg && abs(pi1org)==lporg && abs(pi2org)==lporg && abs(pi3org)==lporg && abs(pi4org)==lporg && rest_sw==0 && gm_bg1<10 && pi0org< 0.5 && rm_xs>999 ) "; // charmonium events(wrong-pi0)
    else if( i%Ncategory== 2 ) sTmp << "  (lpgt==3 && lmgt==3 ) &&  (lpself==1 && lmself==1 && korg==lporg && lporg==lmorg && abs(pi1org)==lporg && abs(pi2org)==lporg && abs(pi3org)==lporg && abs(pi4org)==lporg && rest_sw==0 && gm_bg1<10 && pi0org< 0.5 && rm_xs<999 ) "; // charmonium events(  no -pi0)
    else if( i%Ncategory== 3 ) sTmp << "  (lpgt==3 && lmgt==3 ) &&  (lpself==1 && lmself==1 && korg==lporg && lporg==lmorg && abs(pi1org)==lporg && abs(pi2org)==lporg && abs(pi3org)==lporg && abs(pi4org)==lporg && rest_sw==0 && gm_bg1<10 && pi0org< 0.5 && rm_xs<999 ) "; // charmonium events(  no -pi0)
    else if( i%Ncategory== 4 ) sTmp << " 1 "; // total
    */

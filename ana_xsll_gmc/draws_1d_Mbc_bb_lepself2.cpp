...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  const Int_t add[Nhist][Nchain] ={
    ...
    { 0, 1},        // one  leptons is true and the other lepton is false (ee)
    { 0, 0, 1},     // both leptons are false                             (ee)
    {-1,-1,-1, 1},  // cc                                                 (ee)
    { 0, 0, 0, 0, 1},          // both leptons are true                              (mm)
    { 0, 0, 0, 0, 0, 1},       // one  leptons is true and the other lepton is false (mm)
    { 0, 0, 0, 0, 0, 0, 1},    // both leptons are false                             (mm)
    { 0, 0, 0, 0,-1,-1,-1, 1}, // cc                                                 (mm)
    { 1, 0, 0, 0, 1},            // both leptons are true                              (ee+mm) 
    { 0, 1, 0, 0, 0, 1},         // one  leptons is true and the other lepton is false (ee+mm)
    { 0, 0, 1, 0, 0, 0, 1},      // both leptons are false                             (ee+mm)
    {-1,-1,-1, 1,-1,-1,-1, 1},   // cc                                                 (ee+mm)
  };
  ...
  c1->Update();
  if( flag_save ){
    c1->Print( Form("pic/%s_bb_lepself2_s0%s.eps",  axis, stream) );
    c1->Print( Form("pic/%s_bb_lepself2_s0%s.root", axis, stream) );
  }

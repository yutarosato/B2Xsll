...
const Double_t xmax[2] = {23.0, 21.16}; // {4.8*4.8, 4.6*4.6} = {23.04, 21.16} // default
//const Double_t xmax[2] = {23.0, 19.8025}; // {4.8*4.8, 4.45*4.45} = {23.04, 19.8025} // for syst. study of mb=4.65 GeV
//const Double_t xmax[2] = {23.0, 20.25}; // {4.8*4.8, 4.5*4.5} = {23.04, 20.25} // for syst. study of ms=0.30 GeV
...
Double_t d2bdsdz( const Double_t* x, const Double_t* p){
  ...
  Double_t mseff  = 0.2;
  //Double_t mseff  = 0.3; // for syst. study // * xmax should be adjusted
  //Double_t mseff  = 0.1; // for syst. study
  Double_t ml     = 0.0;
...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  c1->Print( "pic/theory_curve_c1.eps" );  
  ...
  c2->Print( "pic/theory_curve_c2.eps" );
  ...
  g2_afb_bin_obs_lep1 ->Draw("Psame");
  g2_afb_bin_obs_lep0 ->Draw("Psame");
  c3->Print( "pic/theory_curve_c3.eps" );

  TFile outfile( "pic/theory_curve.root", "RECREATE" );
  c1->Write();
  c2->Write();
  g2_afb_true         ->Write();
  g2_afb_obs          ->Write();

...
Int_t main( Int_t argc, Char_t** argv ){
  //using namespace sigmc_cut2;
  //using namespace sigmc_calib_cut2;
  using namespace sigmc_cut2_c10sym;
  ...
  c1->Update();
  if( flag_save ) c1->Print( Form("pic/2d_q2_theta_cut2_lep%d_xsid%d_set%s.eps", fl_mode_ll, fl_xsid, setname) );

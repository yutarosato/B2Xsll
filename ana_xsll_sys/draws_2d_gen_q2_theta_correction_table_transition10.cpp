...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  const Double_t add[Nchain][Ntmp] = {1,1,1.1191,1.1191,1.1191,1.1191,1.1191,1.1191,1.1191,1.1191,1.1191,1.1191,1.1191,1.1191,1.1191,1.1191,1.1191,1.1191,1.1191};
 ...
 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  // cut change
  //
  chain[0]->GetCut()->Set( "gm_fl_xs*Xs_m",    1, 0.0, 0.0, 1.00 ); // h12
  //
  // ++++++++++++++++++++++++
  std::cout << std::endl
  ...
  TFile* file_eff_lep0  = new TFile( "eff_table/transition10/2d_q2_theta_lep0_setA-U_transition10.root" );
  TFile* file_eff_lep1  = new TFile( "eff_table/transition10/2d_q2_theta_lep1_setA-U_transition10.root" );
  ...
  c1->Update();
  if( flag_save ) c1->Print( Form("pic/2d_gen_q2_theta_correction_table_lep%d_set%s_%s_%s_%s_transition10.eps", fl_mode_ll, setname, fl_A7, fl_A9, fl_A10) );

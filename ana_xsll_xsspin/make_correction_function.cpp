...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++;
  //const Char_t* infile     = "correction_table_6qbin_with_corr_xsspin.dat";
  //const Char_t* infile     = "correction_table_6qbin_with_corr_xsspin_fr10.dat";
  //const Char_t* infile     = "correction_table_6qbin_with_corr_xsspin_fr-10.dat"
  //const Char_t* infile     = "correction_table_6qbin_with_corr_xsspin_fr50.dat";
  //const Char_t* infile     = "correction_table_6qbin_with_corr_xsspin_fr-50.dat";
  const Char_t* infile     = "correction_table_6qbin_with_corr_xsspin_fr100.dat";
  //const Char_t* infile     = "correction_table_6qbin_with_corr_xsspin_fr-100.dat";
  ...
  // SAVE
  if( fl_save ){
    c1[0][0]->Print( "pic/correction_table_ee_norm.eps"      );
    c1[0][1]->Print( "pic/correction_table_ee_flip.eps"      );
    c1[1][0]->Print( "pic/correction_table_mm_norm.eps"      );
    c1[1][1]->Print( "pic/correction_table_mm_flip.eps"      );
    c2[0][0]->Print( "pic/correction_table_ee_norm_proj.eps" );
    c2[0][1]->Print( "pic/correction_table_ee_flip_proj.eps" );
    c2[1][0]->Print( "pic/correction_table_mm_norm_proj.eps" );
    c2[1][1]->Print( "pic/correction_table_mm_flip_proj.eps" );
    TFile outfile  ( "pic/correction_function.root", "RECREATE" );

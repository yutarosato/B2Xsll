...
Int_t main( Int_t argc, Char_t** argv ){
  ...
  for( Int_t i=0; i<Nchain; i++ ){
    ...
    // [Category]
    if     ( i==0 ) sTmp << " && ( !(mc_0==1 && mc_1==1 && idmo_0==idmo_1 && abs(idmo_0)==421) && !(mc_0==0 && mc_1==0 && idmo_0==idmo_1 && abs(idmo_0)==421) && mc_0==0 && mc_1==0 )";                                   // fake-D (fake-K & fake-pi)
    else if( i==1 ) sTmp << " && ( !(mc_0==1 && mc_1==1 && idmo_0==idmo_1 && abs(idmo_0)==421) && !(mc_0==0 && mc_1==0 && idmo_0==idmo_1 && abs(idmo_0)==421) && mc_0==1 && mc_1==0 )";                                   // fake-D (true-K & fake-pi)
    else if( i==2 ) sTmp << " && ( !(mc_0==1 && mc_1==1 && idmo_0==idmo_1 && abs(idmo_0)==421) && !(mc_0==0 && mc_1==0 && idmo_0==idmo_1 && abs(idmo_0)==421) && mc_0==0 && mc_1==1 )";                                   // fake-D (fake-K & true-pi)
    else if( i==3 ) sTmp << " && ( !(mc_0==1 && mc_1==1 && idmo_0==idmo_1 && abs(idmo_0)==421) && !(mc_0==0 && mc_1==0 && idmo_0==idmo_1 && abs(idmo_0)==421) && mc_0==1 && mc_1==1 )";                                   // fake-D (true-K & true-pi)
    else if( i==4 ) sTmp << " && ( !(mc_0==1 && mc_1==1 && idmo_0==idmo_1 && abs(idmo_0)==421) &&  (mc_0==0 && mc_1==0 && idmo_0==idmo_1 && abs(idmo_0)==421) && !(mc_2==1 && abs(idmo_2)==413) )"; // fake-D(switch K-pi) + fake-slow-pion
    else if( i==5 ) sTmp << " && ( !(mc_0==1 && mc_1==1 && idmo_0==idmo_1 && abs(idmo_0)==421) &&  (mc_0==0 && mc_1==0 && idmo_0==idmo_1 && abs(idmo_0)==421) &&  (mc_2==1 && abs(idmo_2)==413) )"; // fake-D(switch K-pi) + true-slow-pion
    else if( i==6 ) sTmp << " && (  (mc_0==1 && mc_1==1 && idmo_0==idmo_1 && abs(idmo_0)==421) &&  (mc_2==0) )";                     // true-D, fake-slow-pion(not pion)
    else if( i==7 ) sTmp << " && (  (mc_0==1 && mc_1==1 && idmo_0==idmo_1 && abs(idmo_0)==421) &&  (mc_2==1 && abs(idmo_2)!=413) )"; // true-D, fake-slow-pion
    else if( i==8 ) sTmp << " && (  (mc_0==1 && mc_1==1 && idmo_0==idmo_1 && abs(idmo_0)==421) &&  (mc_2==1 && abs(idmo_2)==413) )"; // true-D*
    else if( i==9 ) sTmp << " && 1";
  ...
  c1->Update();
  if( flag_save ){
    c1->Print    ( Form( "pic/d0_plot_pid%d_par%d_mom%d_cos%d_adef%d.eps",  fl_pid, fl_par, fl_mom, fl_cos, fl_adef) );
    TFile outfile( Form( "pic/d0_plot_pid%d_par%d_mom%d_cos%d_adef%d.root", fl_pid, fl_par, fl_mom, fl_cos, fl_adef), "RECREATE" );
    c1->Write();
